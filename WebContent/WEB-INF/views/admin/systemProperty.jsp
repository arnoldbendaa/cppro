		...
		<div class="modal-body">
			<div class="inner" ng-show="isDataLoaded">
				<div class="form-group">
					...
					<input name="name" id="property" type="text" readonly="readonly" class="form-control">
				</div>
	
				<div class="form-group" ng-class="{true: 'has-error has-feedback',false: 'is-required'}[isError]">
					<label for="">Value:</label>
					<input name="name" id="value" type="text" class="form-control">
				</div>
				<div class="form-group">
					<label for="">Description:</label>
					<textarea rows="2" id="description" readonly="readonly" class="form-control">
					</textarea>
				</div>
			</div>
		</div>
		<div class="modal-footer">
			<button class="btn btn-success" onclick="save()" type="reset">Save</button>
...
<script src="./scripts/systemProperty.js"></script>
</body>
</html>
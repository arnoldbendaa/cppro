...
<head>
    <script type="text/javascript" language="JavaScript1.2">
		...
		{
			var applet = getApplet_byId('de');
			if (!applet.checkEdits())
			{
				return true;
			}
		}
		...
		window.onload = function() {
	 		dojo.byId("crumb").innerHTML += '<span style="font-size:9px"> | '+dojo.byId("dijit_layout__TabButton_0").innerHTML+"</span>";
 		};
	...
	<style type="text/css">
		#dijit_layout_ContentPane_1, #mainTabContainer_tablist, #mainTabContainer_tablist + div  {
			display: none;
		}
	</style>
</head>
...
<div dojoType="dijit.layout.BorderContainer" class="main" gutters="false">
		...
		<div region="center" id="mainTabContainer" widgetId="mainTabContainer" dojoType="dijit.layout.TabContainer" persist="true" tabStrip="false" style="width: 100%" tabPosition="top">
			<div id="data" dojoType="dijit.layout.ContentPane"
				title="<bean:write name="reviewBudgetForm" property="submitModelName" /> <bean:write name="reviewBudgetForm" property="submitCycleName" />">

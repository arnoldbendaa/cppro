...
<table border="1" width="100%">
	<tr>
		<th colspan="2">&nbsp;</th>
		<th width="50%"><bean:message key="cp.commumication.list.to"/></th>
	...
	<logic:notEmpty name="communicationListForm" property="messages">
		<logic:iterate name="communicationListForm" id="messageList" property="messages" type="com.cedar.cp.utc.struts.message.MessageDTO" indexId="rowIndex">
			<% String scriptString = "javascript:openMessage('system', '" + messageList.getMessageId() + "', 'sentList' )";%>
			<% String toggleString = "javascript:toggle(this, '" + messageList.getMessageId() + "', '" + messageList.getMessageUserId()  + "' )"; %>
			<tr>
				<td>
					<input type="checkbox" onclick="<%=toggleString%>" value="select" id="sentBox<%=rowIndex%>"/>
				</td>				
				...
				<td align="left" width="50%">
					<html:link href="<%=scriptString%>"><bean:write name="messageList" property="toUser"/></html:link>
				</td>
				<td align="left">

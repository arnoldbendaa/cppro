...
<div id="tab1" dojoType="ContentPane" selected="true" label='<bean:write name="model" property="name"/> ' style="overflow:auto;">
<table width="100%">
    <tr>
...
<table width="100%" cellpadding="1" cellspacing="1">
    ...
    <tr>
        <th width="4%"><img height="11" alt="" align="middle" src="<%=request.getContextPath()%>/images/red.gif" title='<bean:message key="cp.approver.key.none" />'></th>
...
<div id="tab2" dojoType="ContentPane" selected="false" label="Budget Instructions" href='<%=request.getContextPath()%>/budgetInstructions.do?modelId=<bean:write name="workbenchForm" property="modelId"/>' style="overflow:auto;display:none">
</div>
</div>

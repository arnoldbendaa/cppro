...
<div dojoType="dojox.layout.ExpandoPane" region="leading" style="width:220px;" duration="125" maxWidth="220" title="Actions">
	<div dojoType="dijit.layout.ContentPane" style="padding-right:26px">
		<ul>
			<li><span class="menuItem" onclick="openReportView('new');"><bean:message key="cp.reports.new"/></span></li>
			<li><span class="menuItem"onclick="refreshContent();"><bean:message key="cp.reports.refresh"/></span></li>
		</ul>
	</div>
</div>	

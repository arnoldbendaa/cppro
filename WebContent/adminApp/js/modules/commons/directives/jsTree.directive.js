  ...
  var treeDir = {
    ...
    link: function(s, e, a) { // scope, element, attribute \O/
      $(function() {
        ...
        } else if (a.treeAjax || e.attr('tree-ajax') !== undefined) {
          s.$watch(function() {
            return e.attr('tree-ajax');
          }, function(newValue) {
    ...
    init: function(s, e, a, config) {
      if (treeDir.tree !== undefined) {
        var treeToDestroy = treeDir.tree.jstree();
        if (treeToDestroy)
          treeDir.tree.jstree().destroy();
      }

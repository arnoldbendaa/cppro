...
%>
<!DOCTYPE html>
<html ng-app="lookupAuctionApp" class="lookupAuctionApp">
    <head>
        <title>Auction - Lookup Table</title>
    ...
    <body class="bonhamsLookupAuctionApp" ng-controller="AuctionController">
        <div class="timer">
        ...
        <div id="container-full">
            <div id="container-navbar" role="navigation">
                <h2 class="pageTitle pull-left" >Auction Lookup</h2>
                <div class="pull-right">
                    <button class="btn btn-default btn-sm pull-right import-btn" ng-click="importData()" ng-disabled="checked"><i id="importData" class="fa fa-download"></i> Import data</button>
                </div>
    ...
    <script type="text/javascript" src="<%= path %>/lookuptableApp/js/lookupAuctionApp.js"></script>

    <script type="text/javascript" src="<%= path %>/lookuptableApp/js/modules/auction/auction.js"></script>
    <script type="text/javascript" src="<%= path %>/lookuptableApp/js/modules/auction/controllers/auctionController.js"></script>
    <script type="text/javascript" src="<%= path %>/lookuptableApp/js/modules/auction/providers/auctionService.js"></script>

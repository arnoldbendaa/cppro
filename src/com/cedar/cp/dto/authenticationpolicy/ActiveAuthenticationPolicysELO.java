...
public class ActiveAuthenticationPolicysELO extends AbstractELO implements Serializable {
   ...
   public ActiveAuthenticationPolicysELO() {
      super(new String[]{"AuthenticationPolicy", "VisId", "Description", "AuthenticationTechnique"});
   }

   public void add(AuthenticationPolicyRef eRefAuthenticationPolicy, String col1, String col2, int col3) {

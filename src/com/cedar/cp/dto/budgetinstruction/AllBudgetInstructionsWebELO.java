...
public class AllBudgetInstructionsWebELO extends AbstractELO implements Serializable {
   ...
   public AllBudgetInstructionsWebELO() {
      super(new String[]{"BudgetInstruction", "BudgetInstructionId", "DocumentRef"});
   }

   public void add(BudgetInstructionRef eRefBudgetInstruction, int col1, String col2) {
   ...
   public void next() {
      ...
      this.mBudgetInstructionId = ((Integer)l.get(var4++)).intValue();

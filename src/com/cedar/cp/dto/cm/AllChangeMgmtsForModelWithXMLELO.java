...
public class AllChangeMgmtsForModelWithXMLELO extends AbstractELO implements Serializable {
   ...
   private transient String mXmlText;


   public AllChangeMgmtsForModelWithXMLELO() {
      super(new String[]{"ChangeMgmt", "Model", "CreatedTime", "SourceSystem", "TaskId", "XmlText"});
   }

   public void add(ChangeMgmtRef eRefChangeMgmt, ModelRef eRefModel, Timestamp col1, String col2, int col3, String col4) {
   ...
   public void next() {
      ...
      this.mXmlText = (String)l.get(var4++);
   }

...
public class AllNotPlannableELO extends AbstractELO implements Serializable {
   ...
   public AllNotPlannableELO() {
      super(new String[]{"StructureElement", "StructureElementId", "VisId", "NotPlannable"});
   }

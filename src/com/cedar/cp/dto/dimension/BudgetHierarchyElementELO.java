...
public class BudgetHierarchyElementELO extends AbstractELO implements Serializable {
   ...
   public BudgetHierarchyElementELO() {
      super(new String[]{"StructureElement", "StructureElementId", "VisId", "Description", "Position", "EndPosition", "Depth", "Leaf", "Disabled", "NotPlannable"});
   }

   public void add(StructureElementRef eRefStructureElement, int col1, String col2, String col3, int col4, int col5, int col6, boolean col7, boolean col8, boolean col9) {

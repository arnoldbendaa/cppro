...
public class CalendarForFinanceCubeELO extends AbstractELO implements Serializable {

   private static final String[] mEntity = new String[]{"Hierarchy", "Dimension", "HierarchyElement", "HierarchyElementFeed", "AugHierarchyElement", "FinanceCube", "Model", "ModelDimensionRel", "Model"};
   ...
   public CalendarForFinanceCubeELO() {
      super(new String[]{"Hierarchy", "Dimension", "FinanceCube", "Model", "ModelDimensionRel", "HierarchyId"});
   }

   public void add(HierarchyRef eRefHierarchy, DimensionRef eRefDimension, FinanceCubeRef eRefFinanceCube, ModelRef eRefModel, ModelDimensionRelRef eRefModelDimensionRel, int col1) {

...
public class MassStateImmediateChildrenELO extends AbstractELO implements Serializable {
   ...
   public MassStateImmediateChildrenELO() {
      super(new String[]{"StructureElement", "StructureId", "StructureElementId", "VisId", "Description", "Position", "Depth", "Leaf", "IsCredit", "CalElemType", "Disabled", "NotPlannable"});
   }

   public void add(StructureElementRef eRefStructureElement, int col1, int col2, String col3, String col4, int col5, int col6, boolean col7, boolean col8, int col9, boolean col10, boolean col11) {

...
public class SelectedHierarchysELO extends AbstractELO implements Serializable {
	...
	private transient String mCompanies;

	public SelectedHierarchysELO() {
		super(new String[] { "Hierarchy", "Dimension", "ModelDimensionRel", "Model", "Description", "Type", "Companies" });
	}

	public void add(HierarchyRef eRefHierarchy, DimensionRef eRefDimension, ModelDimensionRelRef eRefModelDimensionRel, ModelRef eRefModel, String col1, int col2, String companies) {
	...
	public void next() {
		...
		this.mCompanies = (String) l.get(var4++);
	}

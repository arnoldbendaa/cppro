...
public class StructureElementELO extends AbstractELO implements Serializable {
   ...
   public StructureElementELO() {
      super(new String[]{"StructureElement", "StructureId", "StructureElementId", "VisId", "Description", "Depth", "ParentId", "Leaf"});
   }

   public void add(StructureElementRef eRefStructureElement, int col1, int col2, String col3, String col4, int col5, int col6, Boolean isLeaf) {

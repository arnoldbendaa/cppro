...
public class StructureElementParentsELO extends AbstractELO implements Serializable {
   ...
   public StructureElementParentsELO() {
      super(new String[]{"StructureElement", "StructureId", "StructureElementId", "ParentId"});
   }

   public void add(StructureElementRef eRefStructureElement, int col1, int col2, int col3) {

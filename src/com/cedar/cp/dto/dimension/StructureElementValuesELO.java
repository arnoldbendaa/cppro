...
public class StructureElementValuesELO extends AbstractELO implements Serializable {
   ...
   public StructureElementValuesELO() {
      super(new String[]{"StructureElement", "StructureId", "StructureElementId", "VisId", "Description", "Position", "Leaf", "IsCredit"});
   }

   public void add(StructureElementRef eRefStructureElement, int col1, int col2, String col3, String col4, int col5, boolean col6, boolean col7) {

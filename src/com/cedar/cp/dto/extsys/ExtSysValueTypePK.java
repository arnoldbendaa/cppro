...
/*     */ 
/*     */ public class ExtSysValueTypePK extends PrimaryKey
...
/*     */   String mLedgerVisId;
/*     */   String mValueTypeVisId;
/*     */ 
/*     */   public ExtSysValueTypePK(int newExternalSystemId, String newCompanyVisId, String newLedgerVisId, String newValueTypeVisId)
/*     */   {
/*  26 */     this.mExternalSystemId = newExternalSystemId;
/*  27 */     this.mCompanyVisId = newCompanyVisId;
/*  28 */     this.mLedgerVisId = newLedgerVisId;
/*  29 */     this.mValueTypeVisId = newValueTypeVisId;
/*     */   }
/*     */ 
...
/*     */   {
/*  59 */     return this.mValueTypeVisId;
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/*  72 */       this.mHashCode += this.mValueTypeVisId.hashCode();
/*     */     }
/*     */ 
...
/*     */   {
/*  83 */     ExtSysValueTypePK other = null;
/*     */ 
/*  85 */     if ((obj instanceof ExtSysValueTypeCK)) {
/*  86 */       other = ((ExtSysValueTypeCK)obj).getExtSysValueTypePK();
/*     */     }
/*  88 */     else if ((obj instanceof ExtSysValueTypePK))
/*  89 */       other = (ExtSysValueTypePK)obj;
/*     */     else {
/*  91 */       return false;
/*     */     }
/*  93 */     boolean eq = true;
...
/*  98 */     eq = (eq) && (this.mValueTypeVisId.equals(other.mValueTypeVisId));
/*     */ 
/* 100 */     return eq;
/*     */   }
/*     */ 
...
/* 115 */     sb.append(",ValueTypeVisId=");
/* 116 */     sb.append(this.mValueTypeVisId);
...
/* 132 */     sb.append(",");
/* 133 */     sb.append(this.mValueTypeVisId);
/* 134 */     return "ExtSysValueTypePK|" + sb.toString().substring(1);
/*     */   }
/*     */ 
/*     */   public static ExtSysValueTypePK getKeyFromTokens(String extKey)
/*     */   {
...
/*     */     }
/* 144 */     if (!extValues[0].equals("ExtSysValueTypePK")) {
/* 145 */       throw new IllegalStateException(extKey + ": format incorrect - must start with 'ExtSysValueTypePK|'");
/*     */     }
...
/* 153 */     String pValueTypeVisId = new String(extValues[(i++)]);
/* 154 */     return new ExtSysValueTypePK(pExternalSystemId, pCompanyVisId, pLedgerVisId, pValueTypeVisId);
/*     */   }
/*     */ }

/* Location:           /home/oracle/coa/cp.ear/cp-extracted/utc.war/cp-common.jar
 * Qualified Name:     com.cedar.cp.dto.extsys.ExtSysValueTypePK

...
public class MessageFromUserELO extends AbstractELO implements Serializable {
   ...
   public MessageFromUserELO() {
      super(new String[]{"MessageUser", "Message", "User", "MessageId", "UserId", "Name", "FullName", "EMailAddress"});
   }

   public void add(MessageUserRef eRefMessageUser, MessageRef eRefMessage, UserRef eRefUser, long col1, String col2, String col3, String col4, String col5) {

...
public class AllCellCalcsELO extends AbstractELO implements Serializable {
   ...
   public AllCellCalcsELO() {
      super(new String[]{"CellCalc", "Model", "Description"});
   }

   public void add(CellCalcRef eRefCellCalc, ModelRef eRefModel, String col1) {

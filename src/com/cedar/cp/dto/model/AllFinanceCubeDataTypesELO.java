...
public class AllFinanceCubeDataTypesELO extends AbstractELO implements Serializable {
   ...
   public AllFinanceCubeDataTypesELO() {
      super(new String[]{"FinanceCubeDataType", "FinanceCube", "Model", "FinanceCubeId", "DataTypeId"});
   }

   public void add(FinanceCubeDataTypeRef eRefFinanceCubeDataType, FinanceCubeRef eRefFinanceCube, ModelRef eRefModel, int col1, short col2) {
      ArrayList l = new ArrayList();
      l.add(eRefFinanceCubeDataType);
      l.add(eRefFinanceCube);
      l.add(eRefModel);
      l.add(new Integer(col1));
      l.add(new Short(col2));

...
public class AllFinanceCubesWebELO extends AbstractELO implements Serializable {
   ...
   public AllFinanceCubesWebELO() {
      super(new String[]{"FinanceCube", "Model", "ModelId", "FinanceCubeId", "VisId", "Description"});
   }

   public void add(FinanceCubeRef eRefFinanceCube, ModelRef eRefModel, int col1, int col2, String col3, String col4) {

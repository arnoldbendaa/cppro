...
public class AllModelBusinessDimensionsELO extends AbstractELO implements Serializable {
   ...
   public AllModelBusinessDimensionsELO() {
      super(new String[]{"ModelDimensionRel", "Model", "DimensionId", "ModelId"});
   }

   public void add(ModelDimensionRelRef eRefModelDimensionRel, ModelRef eRefModel, int col1, int col2) {

...
public class AllModelsWithActiveCycleForUserELO extends AbstractELO implements Serializable {
   ...
   public AllModelsWithActiveCycleForUserELO() {
      super(new String[]{"ModelId", "VisId", "Description", "BudgetHierarchyId"});
   }

   public void add(int col1, String col2, String col3, int col4) {
   ...
   public void next() {
      ...
      byte index = 0;
      int var4 = index + 1;
      this.mModelId = ((Integer)l.get(index)).intValue();

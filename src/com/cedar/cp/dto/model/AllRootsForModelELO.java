...
public class AllRootsForModelELO extends AbstractELO implements Serializable {
   ...
   public AllRootsForModelELO() {
      super(new String[]{"Model", "StructureElement", "ModelDimensionRel", "Dimension", "Hierarchy", "VisId", "StructureId", "StructureElementId", "Description", "ParentId", "ChildIndex", "Depth", "Position", "Leaf", "IsCredit", "Disabled", "BudgetHierarchyId", "DimensionSeqNum", "Type", "DimensionId"});
   }

   public void add(ModelRef eRefModel, StructureElementRef eRefStructureElement, ModelDimensionRelRef eRefModelDimensionRel, DimensionRef eRefDimension, HierarchyRef eRefHierarchy, String col1, int col2, int col3, String col4, int col5, int col6, int col7, int col8, boolean col9, boolean col10, boolean col11, int col12, int col13, int col14, int col15) {
      ...
      l.add(new Integer(col13));
      l.add(new Integer(col14));
      l.add(new Integer(col15));

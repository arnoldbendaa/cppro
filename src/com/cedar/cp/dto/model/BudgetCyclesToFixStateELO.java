...
public class BudgetCyclesToFixStateELO extends AbstractELO implements Serializable {
   ...
   public void next() {
      ...
      byte index = 0;
      int var4 = index + 1;
      this.mBudgetHierarchyId = ((Integer)l.get(index)).intValue();

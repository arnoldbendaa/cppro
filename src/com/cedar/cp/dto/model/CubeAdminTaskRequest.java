...
public class CubeAdminTaskRequest extends AbstractTaskRequest {
   ...
   public CubeAdminTaskRequest(int financeCubeId, String visId, String description, int numDims, int action) {
   ...
   public String getService() {
      return "com.cedar.cp.ejb.base.async.cubeadmin.CubeAdminTask";
   }

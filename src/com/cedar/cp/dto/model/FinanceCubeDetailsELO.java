...
public class FinanceCubeDetailsELO extends AbstractELO implements Serializable {
   ...
   public FinanceCubeDetailsELO() {
      super(new String[]{"FinanceCube", "Model", "ModelId", "FinanceCubeId", "VisId", "Description", "CubeFormulaEnabled"});
   }

   public void add(FinanceCubeRef eRefFinanceCube, ModelRef eRefModel, int col1, int col2, String col3, String col4, boolean col5) {

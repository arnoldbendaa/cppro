...
public class ModelDetailsWebELO extends AbstractELO implements Serializable {
   ...
   public ModelDetailsWebELO() {
      super(new String[]{"Model", "ModelId", "VisId", "Description"});
   }

   public void add(ModelRef eRefModel, int col1, String col2, String col3) {

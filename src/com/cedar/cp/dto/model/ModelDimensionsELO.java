...
public class ModelDimensionsELO extends AbstractELO implements Serializable {
   ...
   public ModelDimensionsELO() {
      super(new String[]{"Model", "Dimension", "ModelDimensionRel", "Description", "DimensionType", "DimensionSeqNum"});
   }

   public void add(ModelRef eRefModel, DimensionRef eRefDimension, ModelDimensionRelRef eRefModelDimensionRel, String col1, int col2, int col3) {

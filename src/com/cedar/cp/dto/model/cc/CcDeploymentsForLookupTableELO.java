...
public class CcDeploymentsForLookupTableELO extends AbstractELO implements Serializable {
   ...
   public CcDeploymentsForLookupTableELO() {
      super(new String[]{"CcDeployment", "Model", "XmlForm", "Description"});
   }

   public void add(CcDeploymentRef eRefCcDeployment, ModelRef eRefModel, XmlFormRef eRefXmlForm, String col1) {

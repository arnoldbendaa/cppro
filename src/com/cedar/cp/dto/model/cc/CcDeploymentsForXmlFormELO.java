...
public class CcDeploymentsForXmlFormELO extends AbstractELO implements Serializable {
   ...
   public CcDeploymentsForXmlFormELO() {
      super(new String[]{"CcDeployment", "Model", "Description"});
   }

   public void add(CcDeploymentRef eRefCcDeployment, ModelRef eRefModel, String col1) {

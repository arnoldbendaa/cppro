...
public class AllGlobalMappedModels2ELO extends AbstractELO implements Serializable {
   ...
   public AllGlobalMappedModels2ELO() {
   ...
   public void add(GlobalMappedModel2Ref eRefMappedModel, ExternalSystemRef eRefExternalSystem, ModelRef eRefModel, int col1, int col2, int col3, String col4, String col5, String col6, String col7, String col8) {

...
/*     */ 
/*     */ public class MappedCalendarYearCK extends GlobalMappedModel2CK
/*     */   implements Serializable
/*     */ {
/*     */   protected MappedCalendarYearPK mMappedCalendarYearPK;
/*     */ 
/*     */   public MappedCalendarYearCK(GlobalMappedModel2PK paramMappedModelPK, MappedCalendarYearPK paramMappedCalendarYearPK)
/*     */   {
...
/* 114 */     i = 1;
/* 115 */     return new MappedCalendarYearCK(GlobalMappedModel2PK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedCalendarYearPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]));
/*     */   }
/*     */ 

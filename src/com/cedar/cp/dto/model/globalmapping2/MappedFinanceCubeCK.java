...
/*     */ 
/*     */ public class MappedFinanceCubeCK extends GlobalMappedModel2CK
/*     */   implements Serializable
/*     */ {
/*     */   protected MappedFinanceCubePK mMappedFinanceCubePK;
/*     */ 
/*     */   public MappedFinanceCubeCK(GlobalMappedModel2PK paramMappedModelPK, MappedFinanceCubePK paramMappedFinanceCubePK)
/*     */   {
...
/* 114 */     i = 1;
/* 115 */     return new MappedFinanceCubeCK(GlobalMappedModel2PK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedFinanceCubePK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]));
/*     */   }
/*     */ 

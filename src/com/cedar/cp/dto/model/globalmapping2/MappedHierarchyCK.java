...
/*     */ 
/*     */   public MappedHierarchyCK(GlobalMappedModel2PK paramMappedModelPK, MappedDimensionPK paramMappedDimensionPK, MappedHierarchyPK paramMappedHierarchyPK)
/*     */   {
...
/* 120 */     i = 1;
/* 121 */     return new MappedHierarchyCK(GlobalMappedModel2PK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedDimensionPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedHierarchyPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]));
/*     */   }
/*     */ 

...
/*     */ 
/*     */   public MappedCalendarElementCK(MappedModelPK paramMappedModelPK, MappedCalendarYearPK paramMappedCalendarYearPK, MappedCalendarElementPK paramMappedCalendarElementPK)
/*     */   {
...
/* 120 */     i = 1;
/* 121 */     return new MappedCalendarElementCK(MappedModelPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedCalendarYearPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedCalendarElementPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]));
/*     */   }
/*     */ 

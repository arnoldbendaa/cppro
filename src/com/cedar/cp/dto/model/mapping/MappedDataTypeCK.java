...
/*     */ 
/*     */   public MappedDataTypeCK(MappedModelPK paramMappedModelPK, MappedFinanceCubePK paramMappedFinanceCubePK, MappedDataTypePK paramMappedDataTypePK)
/*     */   {
...
/* 120 */     i = 1;
/* 121 */     return new MappedDataTypeCK(MappedModelPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedFinanceCubePK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedDataTypePK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]));
/*     */   }
/*     */ 

...
/*     */ 
/*     */ public class MappedDimensionCK extends MappedModelCK
/*     */   implements Serializable
/*     */ {
/*     */   protected MappedDimensionPK mMappedDimensionPK;
/*     */ 
/*     */   public MappedDimensionCK(MappedModelPK paramMappedModelPK, MappedDimensionPK paramMappedDimensionPK)
/*     */   {
...
/* 114 */     i = 1;
/* 115 */     return new MappedDimensionCK(MappedModelPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedDimensionPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]));
/*     */   }
/*     */ 

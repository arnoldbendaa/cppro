...
/*     */ 
/*     */   public MappedDimensionElementCK(MappedModelPK paramMappedModelPK, MappedDimensionPK paramMappedDimensionPK, MappedDimensionElementPK paramMappedDimensionElementPK)
/*     */   {
...
/* 120 */     i = 1;
/* 121 */     return new MappedDimensionElementCK(MappedModelPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedDimensionPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]), MappedDimensionElementPK.getKeyFromTokens(token[(i++)] + '|' + token[(i++)]));
/*     */   }
/*     */ 

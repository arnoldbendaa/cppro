...
public class AllReportsForUserELO extends AbstractELO implements Serializable {
   ...
   public AllReportsForUserELO() {
      super(new String[]{"Report", "ReportId", "ReportType", "TaskId", "CreatedTime", "HasUpdates", "UpdatesApplied"});
   }

   public void add(ReportRef eRefReport, int col1, int col2, int col3, Timestamp col4, boolean col5, boolean col6) {

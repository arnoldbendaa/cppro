...
public class AllReportDefCalcByReportTemplateIdELO extends AbstractELO implements Serializable {

   private static final String[] mEntity = new String[]{"ReportDefCalculator", "ReportDefinition"};
   private transient ReportDefCalculatorRef mReportDefCalculatorEntityRef;
   ...
   public AllReportDefCalcByReportTemplateIdELO() {
      super(new String[]{"ReportDefCalculator", "ReportDefinition", "ReportDefinitionId", "ModelId", "StructureElementId", "CcDeploymentId", "ReportTemplateId"});
   }

   public void add(ReportDefCalculatorRef eRefReportDefCalculator, ReportDefinitionRef eRefReportDefinition, int col1, int col2, int col3, int col4, int col5) {
      ArrayList l = new ArrayList();
      l.add(eRefReportDefCalculator);
   ...
   public void next() {
      ...
      byte index = 0;
      int var4 = index + 1;
      this.mReportDefCalculatorEntityRef = (ReportDefCalculatorRef)l.get(index);
   ...
   public ReportDefCalculatorRef getReportDefCalculatorEntityRef() {
      return this.mReportDefCalculatorEntityRef;
   }

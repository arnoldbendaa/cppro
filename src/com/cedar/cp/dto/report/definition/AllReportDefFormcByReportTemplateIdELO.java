...
public class AllReportDefFormcByReportTemplateIdELO extends AbstractELO implements Serializable {
   ...
   public AllReportDefFormcByReportTemplateIdELO() {
      super(new String[]{"ReportDefForm", "ReportDefinition", "ReportDefinitionId", "ModelId", "FormId", "DataTypeId", "ReportTemplateId"});
   }

   public void add(ReportDefFormRef eRefReportDefForm, ReportDefinitionRef eRefReportDefinition, int col1, int col2, int col3, int col4, int col5) {

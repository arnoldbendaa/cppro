...
public class AllNonDisabledUsersELO extends AbstractELO implements Serializable {
   ...
   public AllNonDisabledUsersELO() {
      super(new String[]{"User", "FullName", "EMailAddress"});
   }

   public void add(UserRef eRefUser, String col1, String col2) {

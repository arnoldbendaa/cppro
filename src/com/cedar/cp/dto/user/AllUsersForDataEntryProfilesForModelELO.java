...
public class AllUsersForDataEntryProfilesForModelELO extends AbstractELO implements Serializable {
   ...
   public AllUsersForDataEntryProfilesForModelELO() {
      super(new String[]{"DataEntryProfile", "User"});
   }

   public void add(DataEntryProfileRef eRefDataEntryProfile, UserRef eRefUser) {

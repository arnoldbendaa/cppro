...
public class AllXcellXmlFormsELO extends AbstractELO implements Serializable {
...
private static final String[] mEntity = new String[]{"XmlForm", "XmlFormUserLink", "FinanceCube", "DataEntryProfile"};
   ...
   public AllXcellXmlFormsELO(XmlFormRef mXmlFormEntityRef, FinanceCubeRef mFinanceCubeEntityRef, int mType, String mDescription, int mFinanceCubeId, String mVisId, Timestamp mUpdatedTime) {
	   super();
	   this.mXmlFormEntityRef = mXmlFormEntityRef;
	   this.mFinanceCubeEntityRef = mFinanceCubeEntityRef;
	   this.mType = mType;
	   this.mDescription = mDescription;
	   this.mFinanceCubeId = mFinanceCubeId;
	   this.mVisId = mVisId;
	   this.mUpdatedTime = mUpdatedTime;
   }

   public AllXcellXmlFormsELO() {

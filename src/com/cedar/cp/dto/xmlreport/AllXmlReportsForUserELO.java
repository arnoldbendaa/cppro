...
public class AllXmlReportsForUserELO extends AbstractELO implements Serializable {
   ...
   public AllXmlReportsForUserELO() {
      super(new String[]{"XmlReport", "XmlReportFolderId"});
   }

...
public class DecendentFoldersELO extends AbstractELO implements Serializable {
   ...
   public DecendentFoldersELO() {
      super(new String[]{"XmlReportFolder", "XmlReportFolderId"});
   }

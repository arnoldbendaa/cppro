...
import com.cedar.cp.ejb.base.async.cubeadmin.CubeAdminTask;
import java.util.ArrayList;
import java.util.List;

public class CubeAdminTask$MyCheckpoint extends AbstractTaskCheckpoint {

   private int mAction;


   public CubeAdminTask$MyCheckpoint(int action) {
      this.mAction = action;
   }
   ...
   public List toDisplay() {
      ...
      case 0:
      case 1:
         l.add(CubeAdminTask.mNames[this.getCheckpointNumber()]);
         break;
      case 2:

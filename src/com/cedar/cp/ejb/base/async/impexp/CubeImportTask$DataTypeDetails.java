...
class CubeImportTask$DataTypeDetails {
   ...
   public CubeImportTask$DataTypeDetails(DataTypeRef dataTypeRef, int subType, int measureClass, int measureScale, int measureLength) {

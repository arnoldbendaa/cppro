...
public class TidyTaskEEJB implements EntityBean {

   protected EntityContext mEntityContext;
   private TidyTaskDAO mTidyTaskDAO;
   private transient Log mLog = new Log(this.getClass());


   public TidyTaskPK ejbCreate(TidyTaskEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      TidyTaskPK var4;
      try {
         TidyTaskDAO e = this.getDAO();
   ...
   public void ejbPostCreate(TidyTaskEVO details) throws CreateException, EJBException {}
   ...
   public TidyTaskPK ejbFindByPrimaryKey(TidyTaskPK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public void ejbLoad() {
      TidyTaskPK pk = (TidyTaskPK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   private TidyTaskPK getPK() {
      return (TidyTaskPK)this.mEntityContext.getPrimaryKey();
   }
   ...
   protected TidyTaskDAO getDAO() {
      if(this.mTidyTaskDAO == null) {
         this.mTidyTaskDAO = new TidyTaskDAO();
      }

      return this.mTidyTaskDAO;
   }

   public TidyTaskEVO getDetails(TidyTaskCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public TidyTaskEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public TidyTaskEVO getDetails(TidyTaskCK paramCK) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public TidyTaskEVO setAndGetDetails(TidyTaskEVO evo, String dependants) {

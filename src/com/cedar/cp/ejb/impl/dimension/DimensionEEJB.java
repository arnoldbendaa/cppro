...
public class DimensionEEJB implements EntityBean {
   ...
   public DimensionPK ejbCreate(DimensionEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      DimensionPK var4;
      try {
         DimensionDAO e = this.getDAO();
   ...
   public void ejbPostCreate(DimensionEVO details) throws CreateException, EJBException {}
   ...
   public DimensionPK ejbFindByPrimaryKey(DimensionPK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public void ejbLoad() {
      DimensionPK pk = (DimensionPK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
...
//         }
   ...
   public Collection ejbFindAll() {
      ...
      Collection var2;
      try {
         var2 = this.getDAO().findAll();
      } finally {
         if(timer != null) {
            timer.logDebug("ejbFindAll", "");
         }
   ...
   private DimensionPK getPK() {
      return (DimensionPK)this.mEntityContext.getPrimaryKey();
   }
   ...
   public DimensionEVO getDetails(DimensionCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public DimensionEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public DimensionEVO getDetails(DimensionCK paramCK) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public DimensionEVO setAndGetDetails(DimensionEVO evo, String dependants) {

...
class DimensionEditorEngine$2 implements ServerDimensionEventListener {

   // $FF: synthetic field
   final DimensionEditorEngine this$0;


   DimensionEditorEngine$2(DimensionEditorEngine var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(DimensionEvent e) throws CPException, ValidationException {
      DimensionEditorEngine.accessMethod100(this.this$0, (RemoveDimensionElementEvent)e);
   }
}

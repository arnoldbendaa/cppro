...
class DimensionEditorEngine$3 implements ServerDimensionEventListener {

   // $FF: synthetic field
   final DimensionEditorEngine this$0;


   DimensionEditorEngine$3(DimensionEditorEngine var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(DimensionEvent e) throws CPException, ValidationException {
      DimensionEditorEngine.accessMethod200(this.this$0, (UpdateDimensionElementEvent)e);
   }
}

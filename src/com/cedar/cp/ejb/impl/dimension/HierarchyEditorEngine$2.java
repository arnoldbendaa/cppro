...
class HierarchyEditorEngine$2 implements ServerHierarchyEventListener {

   // $FF: synthetic field
   final HierarchyEditorEngine this$0;


   HierarchyEditorEngine$2(HierarchyEditorEngine var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(HierarchyEvent e) throws CPException, ValidationException {
      HierarchyEditorEngine.accessMethod100(this.this$0, (RemoveHierarchyElementEvent)e);
   }
}

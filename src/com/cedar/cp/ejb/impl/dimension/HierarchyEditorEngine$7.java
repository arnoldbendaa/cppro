...
class HierarchyEditorEngine$7 implements ServerHierarchyEventListener {

   // $FF: synthetic field
   final HierarchyEditorEngine this$0;


   HierarchyEditorEngine$7(HierarchyEditorEngine var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(HierarchyEvent e) throws CPException, ValidationException {
      HierarchyEditorEngine.accessMethod600(this.this$0, (InsertHierarchyElementFeedEvent)e);
   }
}

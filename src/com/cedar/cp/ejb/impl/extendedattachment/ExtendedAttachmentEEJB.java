...
public class ExtendedAttachmentEEJB implements EntityBean {

   protected EntityContext mEntityContext;
   private ExtendedAttachmentDAO mExtendedAttachmentDAO;
   private transient Log mLog = new Log(this.getClass());


   public ExtendedAttachmentPK ejbCreate(ExtendedAttachmentEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      ExtendedAttachmentPK var4;
      try {
         ExtendedAttachmentDAO e = this.getDAO();
   ...
   public void ejbPostCreate(ExtendedAttachmentEVO details) throws CreateException, EJBException {}
   ...
   public ExtendedAttachmentPK ejbFindByPrimaryKey(ExtendedAttachmentPK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      ExtendedAttachmentPK ve;
      try {
   ...
   public void ejbLoad() {
      ExtendedAttachmentPK pk = (ExtendedAttachmentPK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   private ExtendedAttachmentPK getPK() {
      return (ExtendedAttachmentPK)this.mEntityContext.getPrimaryKey();
   }
   ...
   public void ejbPassivate() {
      ...
      this.mExtendedAttachmentDAO = null;
   }
   ...
   protected ExtendedAttachmentDAO getDAO() {
      if(this.mExtendedAttachmentDAO == null) {
         this.mExtendedAttachmentDAO = new ExtendedAttachmentDAO();
      }

      return this.mExtendedAttachmentDAO;
   }

   public ExtendedAttachmentEVO getDetails(ExtendedAttachmentCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public ExtendedAttachmentEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      ExtendedAttachmentEVO var3;
      try {
   ...
   public ExtendedAttachmentEVO setAndGetDetails(ExtendedAttachmentEVO evo, String dependants) {

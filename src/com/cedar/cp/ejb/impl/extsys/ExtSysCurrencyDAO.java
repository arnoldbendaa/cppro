...
/*     */ 
/*     */ public class ExtSysCurrencyDAO extends AbstractDAO
/*     */ {
/*  32 */   Log _log = new Log(getClass());
/*     */   private static final String SQL_SELECT_COLUMNS = "select EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID,EXT_SYS_CURRENCY.COMPANY_VIS_ID,EXT_SYS_CURRENCY.LEDGER_VIS_ID,EXT_SYS_CURRENCY.CURRENCY_VIS_ID,EXT_SYS_CURRENCY.DESCRIPTION";
/*     */   protected static final String SQL_LOAD = " from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ";
/*     */   protected static final String SQL_CREATE = "insert into EXT_SYS_CURRENCY ( EXTERNAL_SYSTEM_ID,COMPANY_VIS_ID,LEDGER_VIS_ID,CURRENCY_VIS_ID,DESCRIPTION) values ( ?,?,?,?,?)";
/*     */   protected static final String SQL_STORE = "update EXT_SYS_CURRENCY set DESCRIPTION = ? where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ";
/*     */   protected static final String SQL_DELETE_BATCH = "delete from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ";
/*     */   public static final String SQL_BULK_GET_ALL = " from EXT_SYS_CURRENCY,EXT_SYS_LEDGER,EXT_SYS_COMPANY where 1=1 and EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID = EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID and EXT_SYS_CURRENCY.COMPANY_VIS_ID = EXT_SYS_LEDGER.COMPANY_VIS_ID and EXT_SYS_CURRENCY.LEDGER_VIS_ID = EXT_SYS_LEDGER.LEDGER_VIS_ID and EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID = EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID and EXT_SYS_LEDGER.COMPANY_VIS_ID = EXT_SYS_COMPANY.COMPANY_VIS_ID and EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID = ? order by  EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID ,EXT_SYS_CURRENCY.COMPANY_VIS_ID ,EXT_SYS_CURRENCY.LEDGER_VIS_ID ,EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID ,EXT_SYS_CURRENCY.COMPANY_VIS_ID ,EXT_SYS_CURRENCY.LEDGER_VIS_ID ,EXT_SYS_CURRENCY.CURRENCY_VIS_ID";
/*     */   protected static final String SQL_GET_ALL = " from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? ";
/*     */   protected ExtSysCurrencyEVO mDetails;
/*     */ 
/*     */   public ExtSysCurrencyDAO(Connection connection)
/*     */   {
/*  39 */     super(connection);
/*     */   }
/*     */ 
/*     */   public ExtSysCurrencyDAO()
/*     */   {
/*     */   }
/*     */ 
/*     */   public ExtSysCurrencyDAO(DataSource ds)
/*     */   {
/*  55 */     super(ds);
/*     */   }
/*     */ 
/*     */   protected ExtSysCurrencyPK getPK()
/*     */   {
/*  63 */     return this.mDetails.getPK();
/*     */   }
/*     */ 
/*     */   public void setDetails(ExtSysCurrencyEVO details)
/*     */   {
/*  72 */     this.mDetails = details.deepClone();
/*     */   }
/*     */ 
/*     */   private ExtSysCurrencyEVO getEvoFromJdbc(ResultSet resultSet_)
/*     */     throws SQLException
/*     */   {
/*  88 */     int col = 1;
/*  89 */     ExtSysCurrencyEVO evo = new ExtSysCurrencyEVO(resultSet_.getInt(col++), resultSet_.getString(col++), resultSet_.getString(col++), resultSet_.getString(col++), resultSet_.getString(col++));
/*     */ 
/*  97 */     return evo;
/*     */   }
/*     */ 
/*     */   private int putEvoKeysToJdbc(ExtSysCurrencyEVO evo_, PreparedStatement stmt_, int startCol_) throws SQLException
/*     */   {
...
/* 106 */     stmt_.setString(col++, evo_.getCurrencyVisId());
/* 107 */     return col;
/*     */   }
/*     */ 
/*     */   private int putEvoDataToJdbc(ExtSysCurrencyEVO evo_, PreparedStatement stmt_, int startCol_) throws SQLException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected void doLoad(ExtSysCurrencyPK pk)
...
/*     */     try
/*     */     {
/* 140 */       stmt = getConnection().prepareStatement("select EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID,EXT_SYS_CURRENCY.COMPANY_VIS_ID,EXT_SYS_CURRENCY.LEDGER_VIS_ID,EXT_SYS_CURRENCY.CURRENCY_VIS_ID,EXT_SYS_CURRENCY.DESCRIPTION from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ");
/*     */ 
/* 143 */       int col = 1;
...
/* 147 */       stmt.setString(col++, pk.getCurrencyVisId());
/*     */ 
...
/*     */     {
/* 161 */       throw handleSQLException(pk, "select EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID,EXT_SYS_CURRENCY.COMPANY_VIS_ID,EXT_SYS_CURRENCY.LEDGER_VIS_ID,EXT_SYS_CURRENCY.CURRENCY_VIS_ID,EXT_SYS_CURRENCY.DESCRIPTION from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */     try
/*     */     {
/* 202 */       stmt = getConnection().prepareStatement("insert into EXT_SYS_CURRENCY ( EXTERNAL_SYSTEM_ID,COMPANY_VIS_ID,LEDGER_VIS_ID,CURRENCY_VIS_ID,DESCRIPTION) values ( ?,?,?,?,?)");
/*     */ 
/* 205 */       int col = 1;
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 220 */       throw handleSQLException(this.mDetails.getPK(), "insert into EXT_SYS_CURRENCY ( EXTERNAL_SYSTEM_ID,COMPANY_VIS_ID,LEDGER_VIS_ID,CURRENCY_VIS_ID,DESCRIPTION) values ( ?,?,?,?,?)", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */       {
/* 263 */         stmt = getConnection().prepareStatement("update EXT_SYS_CURRENCY set DESCRIPTION = ? where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ");
/*     */ 
/* 266 */         int col = 1;
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 287 */       throw handleSQLException(getPK(), "update EXT_SYS_CURRENCY set DESCRIPTION = ? where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */       {
/* 332 */         this.mDetails = ((ExtSysCurrencyEVO)iter2.next());
/*     */ 
...
/* 341 */           deleteStmt = getConnection().prepareStatement("delete from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ");
/*     */         }
/*     */ 
/* 344 */         int col = 1;
...
/* 348 */         deleteStmt.setString(col++, this.mDetails.getCurrencyVisId());
/*     */ 
/* 350 */         if (this._log.isDebugEnabled()) {
/* 351 */           this._log.debug("update", "ExtSysCurrency deleting ExternalSystemId=" + this.mDetails.getExternalSystemId() + ",CompanyVisId=" + this.mDetails.getCompanyVisId() + ",LedgerVisId=" + this.mDetails.getLedgerVisId() + ",CurrencyVisId=" + this.mDetails.getCurrencyVisId());
/*     */         }
/*     */ 
...
/*     */       {
/* 381 */         this.mDetails = ((ExtSysCurrencyEVO)iter1.next());
/*     */ 
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 407 */       throw handleSQLException("delete from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? AND CURRENCY_VIS_ID = ? ", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/* 467 */       owningEVO.setExtSysCurrenciesAllItemsLoaded(true);
/*     */     }
...
/*     */     try
/*     */     {
/* 475 */       stmt = getConnection().prepareStatement("select EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID,EXT_SYS_CURRENCY.COMPANY_VIS_ID,EXT_SYS_CURRENCY.LEDGER_VIS_ID,EXT_SYS_CURRENCY.CURRENCY_VIS_ID,EXT_SYS_CURRENCY.DESCRIPTION from EXT_SYS_CURRENCY,EXT_SYS_LEDGER,EXT_SYS_COMPANY where 1=1 and EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID = EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID and EXT_SYS_CURRENCY.COMPANY_VIS_ID = EXT_SYS_LEDGER.COMPANY_VIS_ID and EXT_SYS_CURRENCY.LEDGER_VIS_ID = EXT_SYS_LEDGER.LEDGER_VIS_ID and EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID = EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID and EXT_SYS_LEDGER.COMPANY_VIS_ID = EXT_SYS_COMPANY.COMPANY_VIS_ID and EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID = ? order by  EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID ,EXT_SYS_CURRENCY.COMPANY_VIS_ID ,EXT_SYS_CURRENCY.LEDGER_VIS_ID ,EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID ,EXT_SYS_CURRENCY.COMPANY_VIS_ID ,EXT_SYS_CURRENCY.LEDGER_VIS_ID ,EXT_SYS_CURRENCY.CURRENCY_VIS_ID");
/*     */ 
/* 477 */       int col = 1;
...
/*     */         }
/* 516 */         if (owningEVO.getExtSysCurrencies() == null)
/*     */         {
/* 518 */           theseItems = new ArrayList();
/* 519 */           owningEVO.setExtSysCurrencies(theseItems);
/* 520 */           owningEVO.setExtSysCurrenciesAllItemsLoaded(true);
/*     */         }
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 531 */       throw handleSQLException("select EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID,EXT_SYS_CURRENCY.COMPANY_VIS_ID,EXT_SYS_CURRENCY.LEDGER_VIS_ID,EXT_SYS_CURRENCY.CURRENCY_VIS_ID,EXT_SYS_CURRENCY.DESCRIPTION from EXT_SYS_CURRENCY,EXT_SYS_LEDGER,EXT_SYS_COMPANY where 1=1 and EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID = EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID and EXT_SYS_CURRENCY.COMPANY_VIS_ID = EXT_SYS_LEDGER.COMPANY_VIS_ID and EXT_SYS_CURRENCY.LEDGER_VIS_ID = EXT_SYS_LEDGER.LEDGER_VIS_ID and EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID = EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID and EXT_SYS_LEDGER.COMPANY_VIS_ID = EXT_SYS_COMPANY.COMPANY_VIS_ID and EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID = ? order by  EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID ,EXT_SYS_CURRENCY.COMPANY_VIS_ID ,EXT_SYS_CURRENCY.LEDGER_VIS_ID ,EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID ,EXT_SYS_CURRENCY.COMPANY_VIS_ID ,EXT_SYS_CURRENCY.LEDGER_VIS_ID ,EXT_SYS_CURRENCY.CURRENCY_VIS_ID", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */     try
/*     */     {
/* 578 */       stmt = getConnection().prepareStatement("select EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID,EXT_SYS_CURRENCY.COMPANY_VIS_ID,EXT_SYS_CURRENCY.LEDGER_VIS_ID,EXT_SYS_CURRENCY.CURRENCY_VIS_ID,EXT_SYS_CURRENCY.DESCRIPTION from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? ");
/*     */ 
/* 580 */       int col = 1;
...
/* 599 */         ExtSysCurrencyEVO currentEVO = null;
/* 600 */         ExtSysCurrencyEVO newEVO = null;
/* 601 */         while (iter.hasNext())
/*     */         {
/* 603 */           newEVO = (ExtSysCurrencyEVO)iter.next();
/* 604 */           Iterator iter2 = currentList.iterator();
/* 605 */           while (iter2.hasNext())
/*     */           {
/* 607 */             currentEVO = (ExtSysCurrencyEVO)iter2.next();
...
/*     */         {
/* 619 */           currentEVO = (ExtSysCurrencyEVO)iter2.next();
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 629 */       throw handleSQLException("select EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID,EXT_SYS_CURRENCY.COMPANY_VIS_ID,EXT_SYS_CURRENCY.LEDGER_VIS_ID,EXT_SYS_CURRENCY.CURRENCY_VIS_ID,EXT_SYS_CURRENCY.DESCRIPTION from EXT_SYS_CURRENCY where    EXTERNAL_SYSTEM_ID = ? AND COMPANY_VIS_ID = ? AND LEDGER_VIS_ID = ? ", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */   }
/*     */ 
/*     */   public ExtSysCurrencyEVO getDetails(ExternalSystemCK paramCK, String dependants)
/*     */     throws ValidationException
/*     */   {
/* 659 */     Timer timer = this._log.isDebugEnabled() ? new Timer(this._log) : null;
/*     */ 
/* 662 */     if (this.mDetails == null) {
/* 663 */       doLoad(((ExtSysCurrencyCK)paramCK).getExtSysCurrencyPK());
/*     */     }
/* 665 */     else if (!this.mDetails.getPK().equals(((ExtSysCurrencyCK)paramCK).getExtSysCurrencyPK())) {
/* 666 */       doLoad(((ExtSysCurrencyCK)paramCK).getExtSysCurrencyPK());
/*     */     }
/*     */ 
/* 669 */     ExtSysCurrencyEVO details = new ExtSysCurrencyEVO();
...
/*     */   }
/*     */ 
/*     */   public ExtSysCurrencyEVO getDetails(ExternalSystemCK paramCK, ExtSysCurrencyEVO paramEVO, String dependants)
/*     */     throws ValidationException
/*     */   {
/* 681 */     ExtSysCurrencyEVO savedEVO = this.mDetails;
/* 682 */     this.mDetails = paramEVO;
/* 683 */     ExtSysCurrencyEVO newEVO = getDetails(paramCK, dependants);
/* 684 */     this.mDetails = savedEVO;
/* 685 */     return newEVO;
/*     */   }
/*     */ 
/*     */   public ExtSysCurrencyEVO getDetails(String dependants)
/*     */     throws ValidationException
/*     */   {
/* 691 */     Timer timer = this._log.isDebugEnabled() ? new Timer(this._log) : null;
/*     */ 
/* 695 */     ExtSysCurrencyEVO details = this.mDetails.deepClone();
/*     */ 
/* 697 */     if (timer != null) {
...
/*     */   {
/* 705 */     return "ExtSysCurrency";
/*     */   }
/*     */ 
/*     */   public ExtSysCurrencyRefImpl getRef(ExtSysCurrencyPK paramExtSysCurrencyPK)
/*     */   {
...
/* 716 */       int col = 1;
/* 717 */       stmt.setInt(col++, paramExtSysCurrencyPK.getExternalSystemId());
/* 718 */       stmt.setString(col++, paramExtSysCurrencyPK.getCompanyVisId());
/* 719 */       stmt.setString(col++, paramExtSysCurrencyPK.getLedgerVisId());
/* 720 */       stmt.setString(col++, paramExtSysCurrencyPK.getCurrencyVisId());
/*     */ 
/* 722 */       resultSet = stmt.executeQuery();
/*     */ 
/* 724 */       if (!resultSet.next()) {
/* 725 */         throw new RuntimeException(getEntityName() + " getRef " + paramExtSysCurrencyPK + " not found");
/*     */       }
/* 727 */       col = 2;
...
/*     */ 
/* 743 */       String textExtSysCurrency = "";
/* 744 */       ExtSysCurrencyCK ckExtSysCurrency = new ExtSysCurrencyCK(newExternalSystemPK, newExtSysCompanyPK, newExtSysLedgerPK, paramExtSysCurrencyPK);
/*     */ 
/* 751 */       ExtSysCurrencyRefImpl localExtSysCurrencyRefImpl = new ExtSysCurrencyRefImpl(ckExtSysCurrency, textExtSysCurrency);
/*     */       return localExtSysCurrencyRefImpl;
/*     */     }
/*     */     catch (SQLException sqle)
/*     */     {
/* 756 */       throw handleSQLException(paramExtSysCurrencyPK, "select 0,EXTERNAL_SYSTEM.EXTERNAL_SYSTEM_ID,EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID,EXT_SYS_COMPANY.COMPANY_VIS_ID,EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID,EXT_SYS_LEDGER.COMPANY_VIS_ID,EXT_SYS_LEDGER.LEDGER_VIS_ID from EXT_SYS_CURRENCY,EXTERNAL_SYSTEM,EXT_SYS_COMPANY,EXT_SYS_LEDGER where 1=1 and EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID = ? and EXT_SYS_CURRENCY.COMPANY_VIS_ID = ? and EXT_SYS_CURRENCY.LEDGER_VIS_ID = ? and EXT_SYS_CURRENCY.CURRENCY_VIS_ID = ? and EXT_SYS_CURRENCY.EXTERNAL_SYSTEM_ID = EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID and EXT_SYS_CURRENCY.COMPANY_VIS_ID = EXT_SYS_LEDGER.COMPANY_VIS_ID and EXT_SYS_CURRENCY.LEDGER_VIS_ID = EXT_SYS_LEDGER.LEDGER_VIS_ID and EXT_SYS_LEDGER.EXTERNAL_SYSTEM_ID = EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID and EXT_SYS_LEDGER.COMPANY_VIS_ID = EXT_SYS_COMPANY.COMPANY_VIS_ID and EXT_SYS_LEDGER.LEDGER_VIS_ID = EXT_SYS_COMPANY.LEDGER_VIS_ID and EXT_SYS_COMPANY.EXTERNAL_SYSTEM_ID = EXTERNAL_SYSTEM.EXTERNAL_SYSTEM_ID and EXT_SYS_COMPANY.COMPANY_VIS_ID = EXTERNAL_SYSTEM.COMPANY_VIS_ID", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */ 
/* 764 */       if (timer != null)
/* 765 */         timer.logDebug("getRef", paramExtSysCurrencyPK); 
/* 765 */     }
/*     */   }
/*     */ 
/*     */   public void insert(ExtSysCurrencyEVO evo)
/*     */     throws DuplicateNameValidationException, ValidationException
/*     */   {
/* 782 */     setDetails(evo);
/* 783 */     doCreate();
 ...
 * Qualified Name:     com.cedar.cp.ejb.impl.extsys.ExtSysCurrencyDAO

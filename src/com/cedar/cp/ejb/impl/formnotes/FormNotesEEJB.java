...
public class FormNotesEEJB implements EntityBean {
   ...
   public FormNotesPK ejbCreate(FormNotesEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      FormNotesPK var4;
      try {
         FormNotesDAO e = this.getDAO();
   ...
   public void ejbPostCreate(FormNotesEVO details) throws CreateException, EJBException {}
   ...
   public FormNotesPK ejbFindByPrimaryKey(FormNotesPK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public void ejbLoad() {
      FormNotesPK pk = (FormNotesPK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   private FormNotesPK getPK() {
      return (FormNotesPK)this.mEntityContext.getPrimaryKey();
   }
   ...
   public FormNotesEVO getDetails(FormNotesCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public FormNotesEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public FormNotesEVO setAndGetDetails(FormNotesEVO evo, String dependants) {

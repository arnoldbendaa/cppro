...
/*      */ import com.cedar.cp.dto.model.globalmapping2.GlobalMappedModel2RefImpl;
...
/*      */ 
/*      */ public class GlobalMappedModel2DAO extends AbstractDAO
/*      */ {
...
/*      */   protected static final String SQL_FIND_BY_PRIMARY_KEY = "select MAPPED_MODEL_ID from MAPPED_MODEL where    MAPPED_MODEL_ID = ?";
			 ...
			 protected static final String SQL_IS_GLOBAL_MODEL = "select GLOBAL from MAPPED_MODEL where MODEL_ID = ? ";
...
/*      */   protected static final String SQL_LOAD = " from MAPPED_MODEL where    MAPPED_MODEL_ID = ?   and   GLOBAL = 'Y'";
/*      */   protected static final String SQL_CREATE = "insert into MAPPED_MODEL ( MAPPED_MODEL_ID,MODEL_ID,EXTERNAL_SYSTEM_ID,COMPANY_VIS_ID,LEDGER_VIS_ID,VERSION_NUM,UPDATED_BY_USER_ID,UPDATED_TIME,CREATED_TIME,GLOBAL) values ( ?,?,?,?,?,?,?,?,?,'Y')";
...
/*      */   protected GlobalMappedModel2EVO mDetails;
/*      */ 
/*      */   public GlobalMappedModel2DAO(Connection connection)
/*      */   {
/*   63 */     super(connection);
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2DAO()
/*      */   {
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2DAO(DataSource ds)
/*      */   {
/*   79 */     super(ds);
/*      */   }
/*      */ 
/*      */   protected GlobalMappedModel2PK getPK()
/*      */   {
...
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2EVO setAndGetDetails(GlobalMappedModel2EVO details, String dependants)
/*      */   {
...
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2PK create()
...
/*      */   }
/*      */ 
/*      */   public void load(GlobalMappedModel2PK pk)
...
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2PK findByPrimaryKey(GlobalMappedModel2PK pk_)
/*      */     throws ValidationException
/*      */   {
...
/*      */   }
/*      */ 
/*      */   protected boolean exists(GlobalMappedModel2PK pk)
/*      */   {
...
/*      */   }
/*      */ 
/*      */   private GlobalMappedModel2EVO getEvoFromJdbc(ResultSet resultSet_)
/*      */     throws SQLException
/*      */   {
/*  233 */     int col = 1;
/*  234 */     GlobalMappedModel2EVO evo = new GlobalMappedModel2EVO(resultSet_.getInt(col++), resultSet_.getInt(col++), resultSet_.getInt(col++), resultSet_.getString(col++), resultSet_.getString(col++), resultSet_.getInt(col++), null, null, null);
/*      */ 
...
/*      */   }
/*      */ 
/*      */   private int putEvoKeysToJdbc(GlobalMappedModel2EVO evo_, PreparedStatement stmt_, int startCol_) throws SQLException
/*      */   {
...
/*      */   }
/*      */ 
/*      */   private int putEvoDataToJdbc(GlobalMappedModel2EVO evo_, PreparedStatement stmt_, int startCol_) throws SQLException
/*      */   {
...
/*      */   }
/*      */ 
/*      */   protected void doLoad(GlobalMappedModel2PK pk)
/*      */     throws ValidationException
/*      */   {
...
/*  367 */       stmt = getConnection().prepareStatement("insert into MAPPED_MODEL ( MAPPED_MODEL_ID,MODEL_ID,EXTERNAL_SYSTEM_ID,COMPANY_VIS_ID,LEDGER_VIS_ID,VERSION_NUM,UPDATED_BY_USER_ID,UPDATED_TIME,CREATED_TIME,GLOBAL) values ( ?,?,?,?,?,?,?,?,?,'Y')");
/*      */ 
/*  370 */       int col = 1;
...
/*      */     catch (SQLException sqle)
/*      */     {
/*  385 */       throw handleSQLException(this.mDetails.getPK(), "insert into MAPPED_MODEL ( MAPPED_MODEL_ID,MODEL_ID,EXTERNAL_SYSTEM_ID,COMPANY_VIS_ID,LEDGER_VIS_ID,VERSION_NUM,UPDATED_BY_USER_ID,UPDATED_TIME,CREATED_TIME,GLOBAL) values ( ?,?,?,?,?,?,?,?,?,'Y')", sqle);
/*      */     }
/*      */     finally
/*      */     {
...
/*  730 */     AllGlobalMappedModels2ELO results = new AllGlobalMappedModels2ELO();
/*      */     try
/*      */     {
...
/*  738 */         col = 2;
/*      */ 
/*  741 */         GlobalMappedModel2PK pkMappedModel = new GlobalMappedModel2PK(resultSet.getInt(col++));
/*      */ 
...
/*      */ 
/*  758 */         GlobalMappedModel2RefImpl erMappedModel = new GlobalMappedModel2RefImpl(pkMappedModel, textMappedModel);
/*      */ 
...
/*      */ 
/*  811 */     if (timer != null) {
/*  812 */       timer.logDebug("getAllGlobalMappedModels2", " items=" + results.size());
/*      */     }
/*      */ 
/*  816 */     return results;
/*      */   }
...
/*  873 */       int col = 1;
/*  874 */       stmt.setInt(col++, param1);
/*  875 */       resultSet = stmt.executeQuery();
/*  876 */       while (resultSet.next())
/*      */       {
/*  878 */         col = 2;
/*      */ 
/*  881 */         GlobalMappedModel2PK pkMappedModel = new GlobalMappedModel2PK(resultSet.getInt(col++));
/*      */ 
...
/*      */ 
/*  908 */         GlobalMappedModel2RefImpl erMappedModel = new GlobalMappedModel2RefImpl(pkMappedModel, textMappedModel);
/*      */ 
...
/*      */ 
/*  971 */     if (timer != null) {
/*  972 */       timer.logDebug("getMappedFinanceCubes", " MappedModelId=" + param1 + " items=" + results.size());
/*      */     }
/*      */ 
/*  977 */     return results;
/*      */   }
/*      */ 
/*      */   private void deleteDependants(GlobalMappedModel2PK pk)
/*      */   {
/* 1058 */     Set emptyStrings = Collections.emptySet();
/* 1059 */     deleteDependants(pk, emptyStrings);
/*      */   }
/*      */ 
/*      */   private void deleteDependants(GlobalMappedModel2PK pk, Set<String> exclusionTables)
/*      */   {
...
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2EVO getDetails(GlobalMappedModel2PK pk, String dependants)
/*      */     throws ValidationException
/*      */   {
/* 1166 */     return getDetails(new GlobalMappedModel2CK(pk), dependants);
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2EVO getDetails(GlobalMappedModel2CK paramCK, String dependants)
/*      */     throws ValidationException
/*      */   {
...
/*      */     {
/* 1206 */       this._log.info("getDetails", "[ALERT] GlobalMappedModel2EVO " + this.mDetails.getPK() + " no longer valid - reloading");
/*      */ 
...
/*      */     }
/*      */ 
/* 1323 */     GlobalMappedModel2EVO details = new GlobalMappedModel2EVO();
...
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2EVO getDetails(String dependants)
/*      */     throws ValidationException
/*      */   {
...
/*      */ 
/* 1392 */     GlobalMappedModel2EVO details = this.mDetails.deepClone();
/*      */ 
/* 1394 */     if (timer != null) {
...
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2Ref getRef(GlobalMappedModel2PK paramMappedModelPK)
/*      */     throws ValidationException
/*      */   {
/* 1459 */     GlobalMappedModel2EVO evo = getDetails(paramMappedModelPK, "");
...
/*      */     {
/* 1578 */       GlobalMappedModel2EVO evo = (GlobalMappedModel2EVO)iter.next();
/* 1579 */       getDependants(evo, dependants);
/*      */     }
/*      */   }
/*      */ 
/*      */   public void getDependants(GlobalMappedModel2EVO evo, String dependants)
/*      */   {
...
/*      */   }
/*      */ 
/*      */   public GlobalMappedModel2PK getMappedModel(ModelRef model)
/*      */   {
...
/* 1689 */       if (rs.next()) {
/* 1690 */         GlobalMappedModel2PK localMappedModelPK = new GlobalMappedModel2PK(rs.getInt(1));
/*      */         return localMappedModelPK;
/*      */       }
/* 1691 */       GlobalMappedModel2PK localMappedModelPK = null;
/*      */       return localMappedModelPK;
/*      */     }
...
/*      */   }
/*      */
				public int getModelID(GlobalMappedModel2PK pk) {
...
/*  816 */     return results;
		    ...
		    public boolean isGlobalMappedModel(int modelId) {
		        ...
		        boolean returnValue;
		        try {
		            stmt = getConnection().prepareStatement(SQL_IS_GLOBAL_MODEL);
		            ...
		            throw handleSQLException(SQL_IS_GLOBAL_MODEL, sqle);
		        } finally {

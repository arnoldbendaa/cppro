...
public class GlobalMappedModel2EVO implements Serializable {

   private transient GlobalMappedModel2PK mPK;
   ...
   public GlobalMappedModel2EVO() {}

   public GlobalMappedModel2EVO(int newMappedModelId, int newModelId, int newExternalSystemId, String newCompanyVisId, String newLedgerVisId, int newVersionNum, Collection newMappedCalendarYears, Collection newMappedFinanceCubes, Collection newMappedDimensions) {
   ...
   public GlobalMappedModel2PK getPK() {
      if(this.mPK == null) {
         this.mPK = new GlobalMappedModel2PK(this.mMappedModelId);
      }
   ...
   public void setDetails(GlobalMappedModel2EVO newDetails) {
   ...
   public GlobalMappedModel2EVO deepClone() {
      GlobalMappedModel2EVO cloned = null;
      ...
      try {
         ...
         cloned = (GlobalMappedModel2EVO)ois.readObject();
         ois.close();
         return cloned;
   ...
   public GlobalMappedModel2Ref getEntityRef(String entityText) {
      return new GlobalMappedModel2RefImpl(this.getPK(), entityText);
   }

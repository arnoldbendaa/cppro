...
import com.cedar.cp.dto.model.globalmapping2.CreateAllExternalViewsTaskRequest;
...
import com.cedar.cp.ejb.impl.model.globalmapping2.GlobalMappedModel2EditorSessionSEJB$1;
...
public class GlobalMappedModel2EditorSessionSEJB extends AbstractSession {
   ...
   private transient GlobalMappedModel2Accessor mMappedModelAccessor;
   private transient ModelAccessor mModelAccessor;
   private transient ExternalSystemAccessor mExternalSystemAccessor;
   private GlobalMappedModel2EditorSessionSSO mSSO;
   private GlobalMappedModel2PK mThisTableKey;
   private GlobalMappedModel2EVO mMappedModelEVO;
   private String companies;


   public GlobalMappedModel2EditorSessionSSO getItemData(int userId, Object paramKey) throws ValidationException, EJBException {
      ...
      this.mThisTableKey = (GlobalMappedModel2PK)paramKey;

      GlobalMappedModel2EditorSessionSSO e;
      try {
   ...
   private void makeItemData() throws Exception {
      this.mSSO = new GlobalMappedModel2EditorSessionSSO();
      GlobalMappedModel2Impl editorData = this.buildMappedModelEditData(this.mThisTableKey);
      this.completeGetItemData(editorData);
      this.mSSO.setEditorData(editorData);
   }

   private void completeGetItemData(GlobalMappedModel2Impl editorData) throws Exception {
   ...
   private GlobalMappedModel2Impl buildMappedModelEditData(Object thisKey) throws Exception {
	  GlobalMappedModel2Impl editorData = new GlobalMappedModel2Impl(thisKey);
   ...
   private void completeMappedModelEditData(GlobalMappedModel2Impl editorData) throws Exception {}

   public GlobalMappedModel2EditorSessionSSO getNewItemData(int userId) throws EJBException {
      this.mLog.debug("getNewItemData");
      this.setUserId(userId);
      Timer timer = this.mLog.isInfoEnabled()?new Timer(this.mLog):null;

      GlobalMappedModel2EditorSessionSSO var4;
      try {
         this.mSSO = new GlobalMappedModel2EditorSessionSSO();
         GlobalMappedModel2Impl e = new GlobalMappedModel2Impl((Object)null);
   ...
   private void completeGetNewItemData(GlobalMappedModel2Impl editorData) throws Exception {}

   public GlobalMappedModel2PK insert(GlobalMappedModel2EditorSessionCSO cso) throws ValidationException, EJBException {
      this.mLog.debug("insert");
      Timer timer = this.mLog.isInfoEnabled()?new Timer(this.mLog):null;
      this.setUserId(cso.getUserId());
      GlobalMappedModel2Impl editorData = cso.getEditorData();

      GlobalMappedModel2PK globalMappedModelPK;
      try {
         this.mMappedModelEVO = new GlobalMappedModel2EVO();
         ...
         this.mMappedModelEVO.setCompanyVisId((editorData.getCompaniesVisId().toString().substring(1, editorData.getCompaniesVisId().toString().length()-1)));
         ...
         globalMappedModelPK = this.mMappedModelEVO.getPK();
      ...
      return globalMappedModelPK;
   }

   private void updateMappedModelRelationships(GlobalMappedModel2Impl editorData) throws ValidationException {
      Object key;
   ...
   private void completeInsertSetup(GlobalMappedModel2Impl editorData) throws Exception {
      this.updateMappedModelEVO(editorData, this.mMappedModelEVO);
   }

   private void insertIntoAdditionalTables(GlobalMappedModel2Impl editorData, boolean isInsert) throws Exception {}

   private void validateInsert() throws ValidationException {}

   public GlobalMappedModel2PK copy(GlobalMappedModel2EditorSessionCSO cso) throws ValidationException, EJBException {
      this.mLog.debug("copy");
      Timer timer = this.mLog.isInfoEnabled()?new Timer(this.mLog):null;
      this.setUserId(cso.getUserId());
      GlobalMappedModel2Impl editorData = cso.getEditorData();
      this.mThisTableKey = (GlobalMappedModel2PK)editorData.getPrimaryKey();

      GlobalMappedModel2PK var5;
      try {
         GlobalMappedModel2EVO e = this.getMappedModelAccessor().getDetails(this.mThisTableKey, "<0><1><2><3><4><5><6>");
   ...
   private void completeCopySetup(GlobalMappedModel2Impl editorData) throws Exception {}

   public void update(GlobalMappedModel2EditorSessionCSO cso) throws ValidationException, EJBException {
   ...
   private void preValidateUpdate(GlobalMappedModel2Impl editorData) throws ValidationException {}

   private void postValidateUpdate() throws ValidationException {}

   private void completeUpdateSetup(GlobalMappedModel2Impl editorData) throws Exception {
      this.updateMappedModelEVO(editorData, this.mMappedModelEVO);
   }

   private void updateAdditionalTables(GlobalMappedModel2Impl editorData) throws Exception {
      this.createCM();
   }
   ...
   private GlobalMappedModel2Accessor getMappedModelAccessor() throws Exception {
      if(this.mMappedModelAccessor == null) {
         this.mMappedModelAccessor = new GlobalMappedModel2Accessor(this.getInitialContext());
      }
   ...
   public void refreshMappedModelCalendar(int userId, GlobalMappedModel2PK paramKey) throws ValidationException, EJBException {
      this.setUserId(userId);
      if(this.mLog.isDebugEnabled()) {
   ...
   private void refreshMappedModelCalendarYear(GlobalMappedModel2EVO globalMappedModelEVO, MappedCalendarYearEVO mcyEVO, List<EntityRef> leavesForYear) {
   ...
   public void refreshMappedModelHierarchy(int userId, GlobalMappedModel2PK paramKey) throws ValidationException, EJBException {
      this.setUserId(userId);
      if(this.mLog.isDebugEnabled()) {
   ...
   private void loadMappedModelFromEVO(GlobalMappedModel2EVO globalMappedModelEVO, GlobalMappedModel2Impl mappedModelImpl) throws ValidationException {
      Model model = this.loadModel(globalMappedModelEVO.getModelId());
      mappedModelImpl.setModelVisId(model.getVisId());
      mappedModelImpl.setModelDescription(model.getDescription());
      this.loadMappedDimensionsFromEVO(globalMappedModelEVO, mappedModelImpl, model);
      this.loadMappedCalendarFromEVO(globalMappedModelEVO, mappedModelImpl, model);
      this.loadMappedFinanceCubesFromEVO(globalMappedModelEVO, mappedModelImpl);
   }

   private void loadMappedFinanceCubesFromEVO(GlobalMappedModel2EVO globalMappedModelEVO, GlobalMappedModel2Impl mappedModelImpl) throws ValidationException {
      EntityList allFinanceCubes = this.getFinanceCubesForModel(globalMappedModelEVO.getModelId());
      Iterator i$ = globalMappedModelEVO.getMappedFinanceCubes().iterator();
   ...
   private void loadMappedCalendarFromEVO(GlobalMappedModel2EVO globalMappedModelEVO, GlobalMappedModel2Impl mappedModelImpl, Model model) throws ValidationException {
      ...
      Iterator i$ = globalMappedModelEVO.getMappedCalendarYears().iterator();

      while(i$.hasNext()) {
         MappedCalendarYearEVO mcyEVO = (MappedCalendarYearEVO)i$.next();
         MappedCalendarYearImpl mcyImpl = new MappedCalendarYearImpl(mcyEVO.getPK(), mcyEVO.getYear(), this.loadMappedCalendarYearElements(mcyEVO, mcImpl), mcyEVO.getCompanies());
         mcImpl.getMappedCalendarYears().add(mcyImpl);
      }

      Collections.sort(mcImpl.getMappedCalendarYears(), new GlobalMappedModel2EditorSessionSEJB$1(this));
   }
   ...
   private void loadMappedDimensionsFromEVO(GlobalMappedModel2EVO globalMappedModelEVO, GlobalMappedModel2Impl mappedModelImpl, Model model) {
      EntityList allDimensions = this.getAllDimensions();
      Iterator i$ = globalMappedModelEVO.getMappedDimensions().iterator();
   ...
   private List<MappedHierarchy> loadMappedHierarchiesFromEVO(MappedDimensionEVO mappedDimensionEVO, Model model) {
      //EntityList allHierarchies = this.getAllHierarchies();
	   EntityList selectedHierarchies = this.getSelectedHierarchies();
      ArrayList items = new ArrayList();
      ...
      while(i$.hasNext()) {
         ...
         while(true) {
            if(hierarchyRef < selectedHierarchies.getNumRows()) {
               if(!((HierarchyRefImpl)selectedHierarchies.getValueAt(hierarchyRef, "Hierarchy")).getPrimaryKey().equals(new HierarchyPK(mhEVO.getHierarchyId()))) {
                  ++hierarchyRef;
                  continue;
               }
            ...
            Object var11 = null;
            String hierarchyDescription, companies = null;
            if(hierRow != -1) {
               var11 = (HierarchyRef)selectedHierarchies.getValueAt(hierRow, "Hierarchy");
               hierarchyDescription = (String)selectedHierarchies.getValueAt(hierRow, "Description");
               companies = (String)selectedHierarchies.getValueAt(hierRow, "Companies");
            } else {
               var11 = new HierarchyRefImpl(new HierarchyPK(-1), "CM Pending...");
               hierarchyDescription = "CM Pending...";
               companies = "CM Pending...";
            }
            ...
            // set companies
            if (companies != null) {
                String[] companiesList = companies.replace("\"", "").split(",");
                for (int i = 0; i < companiesList.length; i++) {
                    mhImpl.setSelectedCompany(companiesList[i], true);
                }
            }
            items.add(mhImpl);
            break;
   ...
   private SortedSet<MappedDimensionElement> loadMappedDimensionElementsFromEVO(MappedDimensionEVO mappedDimensionEVO) {
      ...
      while(i$.hasNext()) {
         ...
         // set companies
         String companies = mdeEVO.getCompanies();
         if (companies != null) {
             String[] companiesList = companies.replace("\"", "").split(",");
             for( int i = 0 ; i < companiesList.length ; i++ ) {
            	 mdeImpl.setSelectedCompany( companiesList[ i ], true);
             }
         }
   ...
   private void updateMappedModelEVO(GlobalMappedModel2Impl mappedModelImpl, GlobalMappedModel2EVO globalMappedModelEVO) throws ValidationException, Exception {
      ModelPK modelPK = null;
      HierarchyCK newCalHierarhcyCK = this.updateMappedCalendar(mappedModelImpl, globalMappedModelEVO);
      if(mappedModelImpl.isNew()) {
    	 this.updateMappedDimensionEVOs(mappedModelImpl, globalMappedModelEVO);
         modelPK = this.createModel(mappedModelImpl, globalMappedModelEVO, newCalHierarhcyCK);
         globalMappedModelEVO.setModelId(modelPK.getModelId());
      } else {
         this.updateMappedDimensionEVOs(mappedModelImpl, globalMappedModelEVO);
         modelPK = new ModelPK(globalMappedModelEVO.getModelId());
      }

      this.updateMappedFinanceCubeEVOs(mappedModelImpl, globalMappedModelEVO, modelPK);
   }

   private void updateMappedFinanceCubeEVOs(GlobalMappedModel2Impl mappedModelImpl, GlobalMappedModel2EVO globalMappedModelEVO, ModelPK modelPK) throws ValidationException, Exception {
      List<MappedFinanceCube> newMappedFinanceCubes = mappedModelImpl.getMappedFinanceCubes();
      Object existingEVOs = globalMappedModelEVO.getMappedFinanceCubes() == null?new ArrayList():globalMappedModelEVO.getMappedFinanceCubes();
      ...
      while(i$.hasNext()) {
         ...
         if(newFinanceCubeCK != null) {
            ...
            globalMappedModelEVO.deleteMappedFinanceCubesItem(mfcImpl.getPK());
         }
      }
      ...
      while (i$.hasNext()) {
         ...
         MappedFinanceCubeEVO mfcEVO = new MappedFinanceCubeEVO(newMappedFinanceCubeId, modelPK.getModelId(), newFinanceCubeCK1.getFinanceCubePK().getFinanceCubeId(), mfcImpl1.getFinanceCompany(), this.createMappedDataTypes(newMappedFinanceCubeId, mfcImpl1));
         globalMappedModelEVO.addMappedFinanceCubesItem(mfcEVO);
      }
   ...
   private HierarchyCK updateMappedCalendar(GlobalMappedModel2Impl mappedModelImpl, GlobalMappedModel2EVO globalMappedModelEVO) throws ValidationException, Exception {
      ...
      if(mappedModelImpl.isNew()) {
         ...
         while(var23.hasNext()) {
            ...
            MappedCalendarYearEVO i$ = new MappedCalendarYearEVO(mappedCalendar, globalMappedModelEVO.getMappedModelId(), changeManagementRequestRequired.getYear(), String.valueOf(changeManagementRequestRequired.getYear()), changeManagementRequestRequired.getCompanies(), this.createMappedCalendarElementEVOs(mappedCalendar, changeManagementRequestRequired, existingEVOs));
            i$.insertPending();
            globalMappedModelEVO.addMappedCalendarYearsItem(i$);
         }
      } else {
         srcCalendarImpl = (CalendarImpl)mappedModelImpl.getMappedCalendar().getCalendar();
         ...
         Object var30 = globalMappedModelEVO.getMappedCalendarYears() == null?new ArrayList():globalMappedModelEVO.getMappedCalendarYears();
         ...
         while(var32.hasNext()) {
            ...
            if(leavesForYear != null) {
               ...
               globalMappedModelEVO.deleteMappedCalendarYearsItem(mcyImpl.getPK());
            }
         }
         ...
         while(var32.hasNext()) {
            ...
            MappedCalendarYearEVO mcyEVO = new MappedCalendarYearEVO(var34, globalMappedModelEVO.getMappedModelId(), var31.getYear(), String.valueOf(var31.getYear()), var31.getCompanies(), this.createMappedCalendarElementEVOs(var34, var31, var33));
            mcyEVO.insertPending();
            globalMappedModelEVO.addMappedCalendarYearsItem(mcyEVO);
         }
      }
   ...
   private void updateMappedCalendarYearEVO(MappedCalendarYearImpl mcyImpl, MappedCalendarYearEVO mcyEVO, List<EntityRef> leavesForYear) {
      String companies = mcyImpl.getCompanies();
      mcyEVO.setCompanies(companies);
   ...
   private void updateMappedDimensionEVOs(GlobalMappedModel2Impl mappedModelImpl, GlobalMappedModel2EVO globalMappedModelEVO) throws ValidationException, Exception {
      List newMappedDimensions = mappedModelImpl.getDimensionMappings();
      Object existingEVOs = globalMappedModelEVO.getMappedDimensions() == null?new ArrayList():globalMappedModelEVO.getMappedDimensions();
      Iterator i$ = ((Collection)existingEVOs).iterator();
      ...
      while(i$.hasNext()) {
         ...
         if(newDimensionId != null) {
            ...
            this.updateMappedDimensionEVO(new ModelRefImpl(new ModelPK(globalMappedModelEVO.getModelId()), mappedModelImpl.getModelVisId()), newDimensionId, mdImpl);
            newMappedDimensions.remove(newDimensionId);
         } else {
            globalMappedModelEVO.deleteMappedDimensionsItem(mdImpl.getPK());
         }
      }
      ...
      while(i$.hasNext()) {
         ...
         MappedDimensionEVO mappedDimensionEVO = new MappedDimensionEVO(newMappedDimensionId, globalMappedModelEVO.getMappedModelId(), newDimensionId1, mdImpl1.getPathVisId(), mdImpl1.isDisabledLeafNodesExcluded(), this.createMappedDimensionElementEVOs(newMappedDimensionId, mdImpl1), this.createMappedHierarhyEVOs(newDimensionId1, newMappedDimensionId, mdImpl1));
         ((MappedDimensionImpl)mdImpl1).setKey(mappedDimensionEVO.getPK());
         globalMappedModelEVO.addMappedDimensionsItem(mappedDimensionEVO);
      }
   ...
   private Collection<MappedDimensionElementEVO> createMappedDimensionElementEVOs(int newMappedDimensionId, MappedDimension mappedDimensionImpl) throws ValidationException, Exception {
      ...
      while(i$.hasNext()) {
         ...
         Hashtable<String,Boolean> selectedCompanies = mde.getSelectedCompanies();
         if (selectedCompanies != null && selectedCompanies.containsValue(true)) {
        	 String companies = convertCompanies(selectedCompanies);
        	 MappedDimensionElementEVO mdeEVO = new MappedDimensionElementEVO(this.getNextId(), newMappedDimensionId, mde.getMappingType(), mde.getVisId1(), mde.getVisId2(), mde.getVisId3(), companies);
   ...
   private Collection<MappedHierarchyEVO> createMappedHierarhyEVOs(int newDimensionId, int newMappedDimensionId, MappedDimension md) throws ValidationException, Exception {
      ...
      while(i$.hasNext()) {
         ...
         Hashtable<String,Boolean> selectedCompanies = mh.getSelectedCompanies();
         if (selectedCompanies != null && selectedCompanies.containsValue(true)) {
        	 String companies = convertCompanies(selectedCompanies);   
	         int newHierarchyId = this.createHierarchy(md, mh);
	         MappedHierarchyEVO mhEVO = new MappedHierarchyEVO(this.getNextId(), newMappedDimensionId, newHierarchyId, mh.getHierarchyVisId1(), mh.getHierarchyVisId2(), (String)null, companies);
   ...
   private String convertCompanies(Hashtable<String,Boolean> selectedCompanies){
       String companies = "";
       Enumeration<String> enumKey = selectedCompanies.keys();
       while (enumKey.hasMoreElements()) {
           String company = enumKey.nextElement();
           Boolean selected = selectedCompanies.get(company);
   ...
   private ModelPK createModel(GlobalMappedModel2Impl mappedModelImpl, GlobalMappedModel2EVO globalMappedModelEVO, HierarchyCK newCalendarCK) throws ValidationException, Exception {
      ...
      Iterator respAreaHierarchy = globalMappedModelEVO.getMappedDimensions().iterator();
      ...
      MappedHierarchyImpl mappedHierarchyImlRespArea = mappedModelImpl.getResponisbilityAreaHierarchy();
      if(mappedHierarchyImlRespArea == null) {
         ...
         for(int i$ = 0; i$ < len$; ++i$) {
            ...
            if(hr.equals(mappedHierarchyImlRespArea.getHierarchyRef())) {
               var15 = hr;
               break;
            }
         }
         ...
         if(var15 != null) {
            ...
            throw new ValidationException("Invalid responsibility area hierarchy:" + mappedHierarchyImlRespArea);
         }
      }
   }
   ...
   private FinanceCubeCK createFinanceCube(MappedFinanceCube mappedFinanceCubeImpl, ModelPK modelPK) throws ValidationException, Exception {
      ...
      ((FinanceCubeImpl) session.getEditorData()).setIsGlobal( true );
      editor.commit();
   ...
   private void updateMappedDimensionElementEVOs(MappedDimensionImpl mappedDimensionImpl, MappedDimensionEVO mappedDimensionEVO) throws Exception {
      ...
      while(i$.hasNext()) {
         ...
         Hashtable<String,Boolean> selectedCompanies = mde1.getSelectedCompanies();
         if (selectedCompanies != null && selectedCompanies.containsValue(true)) {
             String companies = convertCompanies(selectedCompanies);
             MappedDimensionElementEVO mdeEVO1 = new MappedDimensionElementEVO(this.getNextId(), mappedDimensionEVO.getMappedDimensionId(), mde1.getMappingType(), mde1.getVisId1(), mde1.getVisId2(), mde1.getVisId3(), companies);
   ...
   private void updateMappedDimensionElementEVO(MappedDimensionElementImpl mdeImpl, MappedDimensionElementEVO mdeEVO) throws Exception {
      ...
      Hashtable<String,Boolean> selectedCompanies = mdeImpl.getSelectedCompanies();
      if (selectedCompanies != null) {
          String companies = convertCompanies(selectedCompanies);
          mdeEVO.setCompanies(companies);
      }
   }
   ...
   private void updateMappedHierarchyEVO(MappedHierarchyImpl mappedHierarchyImpl, MappedHierarchyEVO mappedHierarchyEVO) {
      ...
      Hashtable<String,Boolean> selectedCompanies = mappedHierarchyImpl.getSelectedCompanies();
      if (selectedCompanies != null) {
          String companies = convertCompanies(selectedCompanies);
          mappedHierarchyEVO.setCompanies(companies);
      }
   }
   ...
   private EntityList getAllHierarchies() {
	...
	private EntityList getSelectedHierarchies() {
		return this.getCPConnection().getHierarchysProcess().getSelectedHierarchys();
	}
   ...
   public int issueModelImportTask(int userId, boolean safeMode, int[] mappedModelIds, int issuingTaskId) throws ValidationException, EJBException {
      ImportGlobalMappedModel2TaskRequest request = new ImportGlobalMappedModel2TaskRequest(safeMode, mappedModelIds);
   ...
   public int getModelId(Object pk) {
	   return new GlobalMappedModel2DAO().getModelID((GlobalMappedModel2PK)pk);
   }
   
   public boolean isGlobalMappedModel(int modelId) {
       return new GlobalMappedModel2DAO().isGlobalMappedModel(modelId);
   }
}

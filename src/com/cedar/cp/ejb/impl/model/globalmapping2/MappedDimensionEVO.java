...
public class MappedDimensionEVO implements Serializable {
   ...
   public MappedDimensionRef getEntityRef(GlobalMappedModel2EVO evoMappedModel, String entityText) {
      return new MappedDimensionRefImpl(new MappedDimensionCK(evoMappedModel.getPK(), this.getPK()), entityText);
   }

   public MappedDimensionCK getCK(GlobalMappedModel2EVO evoMappedModel) {

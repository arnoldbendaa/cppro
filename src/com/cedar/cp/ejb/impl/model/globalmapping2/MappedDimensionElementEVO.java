...
public class MappedDimensionElementEVO implements Serializable {
   ...
   public MappedDimensionElementEVO(int newMappedDimensionElementId, int newMappedDimensionId, int newMappingType, String newElementVisId1, String newElementVisId2, String newElementVisId3) {
	...
	public MappedDimensionElementEVO(int newMappedDimensionElementId, int newMappedDimensionId, int newMappingType, String newElementVisId1, String newElementVisId2, String newElementVisId3, String companies) {
		this.mMappedDimensionElementId = newMappedDimensionElementId;
		this.mMappedDimensionId = newMappedDimensionId;
		this.mMappingType = newMappingType;
		this.mElementVisId1 = newElementVisId1;
   ...
   public MappedDimensionElementRef getEntityRef(GlobalMappedModel2EVO evoMappedModel, MappedDimensionEVO evoMappedDimension, String entityText) {
   ...
   public MappedDimensionElementCK getCK(GlobalMappedModel2EVO evoMappedModel, MappedDimensionEVO evoMappedDimension) {

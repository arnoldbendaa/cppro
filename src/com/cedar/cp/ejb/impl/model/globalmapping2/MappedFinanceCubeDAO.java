...
/*      */   {
/*   92 */     int col = 1;
/*   93 */     MappedFinanceCubeEVO evo = new MappedFinanceCubeEVO(resultSet_.getInt(col++), resultSet_.getInt(col++), resultSet_.getInt(col++), resultSet_.getString(col++), null);
/*      */ 
...
/*  117 */     stmt_.setInt(col++, evo_.getFinanceCubeId());
			   stmt_.setString(col++, evo_.getCompany());
...
/*  210 */       stmt = getConnection().prepareStatement("insert into MAPPED_FINANCE_CUBE ( MAPPED_FINANCE_CUBE_ID, MAPPED_MODEL_ID, FINANCE_CUBE_ID, COMPANY, UPDATED_BY_USER_ID, UPDATED_TIME, CREATED_TIME) values ( ?,?,?,?,?,?,? )");
/*      */ 
/*  213 */       int col = 1;
...
/*  290 */         stmt = getConnection().prepareStatement("update MAPPED_FINANCE_CUBE set MAPPED_MODEL_ID = ?,FINANCE_CUBE_ID = ?, COMPANY = ?, UPDATED_BY_USER_ID = ?,UPDATED_TIME = ?,CREATED_TIME = ? where    MAPPED_FINANCE_CUBE_ID = ? ");
/*      */ 
/*  293 */         int col = 1;
...
/*      */   }
/*      */ 
/*      */   public MappedFinanceCubeEVO getDetails(GlobalMappedModel2CK paramCK, String dependants)
/*      */     throws ValidationException
/*      */   {
...
/*      */   }
/*      */ 
/*      */   public MappedFinanceCubeEVO getDetails(GlobalMappedModel2CK paramCK, MappedFinanceCubeEVO paramEVO, String dependants)
/*      */     throws ValidationException
/*      */   {
...
/*      */       }
/*  869 */       col = 2;
/*  870 */       GlobalMappedModel2PK newMappedModelPK = new GlobalMappedModel2PK(resultSet.getInt(col++));
/*      */ 

...
/*     */   {
/*  92 */     int col = 1;
/*  93 */     MappedDimensionElementEVO evo = new MappedDimensionElementEVO(resultSet_.getInt(col++), resultSet_.getInt(col++), resultSet_.getInt(col++), resultSet_.getString(col++), resultSet_.getString(col++), resultSet_.getString(col++));
/*     */ 
...
/* 219 */       stmt = getConnection().prepareStatement("insert into MAPPED_DIMENSION_ELEMENT ( MAPPED_DIMENSION_ELEMENT_ID,MAPPED_DIMENSION_ID,MAPPING_TYPE,ELEMENT_VIS_ID_1,ELEMENT_VIS_ID_2,ELEMENT_VIS_ID_3,UPDATED_BY_USER_ID,UPDATED_TIME,CREATED_TIME) values ( ?,?,?,?,?,?,?,?,?)");
/*     */ 
/* 222 */       int col = 1;
...
/* 286 */         stmt = getConnection().prepareStatement("update MAPPED_DIMENSION_ELEMENT set MAPPED_DIMENSION_ID = ?,MAPPING_TYPE = ?,ELEMENT_VIS_ID_1 = ?,ELEMENT_VIS_ID_2 = ?,ELEMENT_VIS_ID_3 = ?,UPDATED_BY_USER_ID = ?,UPDATED_TIME = ?,CREATED_TIME = ? where    MAPPED_DIMENSION_ELEMENT_ID = ? ");
/*     */ 
/* 289 */         int col = 1;
...
/*     */   }
/*     */ 
/*     */   public MappedDimensionElementEVO getDetails(MappedModelCK paramCK, String dependants)
/*     */     throws ValidationException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public MappedDimensionElementEVO getDetails(MappedModelCK paramCK, MappedDimensionElementEVO paramEVO, String dependants)
/*     */     throws ValidationException
/*     */   {

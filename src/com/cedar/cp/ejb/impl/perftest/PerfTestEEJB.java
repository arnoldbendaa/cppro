...
public class PerfTestEEJB implements EntityBean {

   protected EntityContext mEntityContext;
   private PerfTestDAO mPerfTestDAO;
   private transient Log mLog = new Log(this.getClass());


   public PerfTestPK ejbCreate(PerfTestEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      PerfTestPK var4;
      try {
         PerfTestDAO e = this.getDAO();
   ...
   public void ejbPostCreate(PerfTestEVO details) throws CreateException, EJBException {}
   ...
   public PerfTestPK ejbFindByPrimaryKey(PerfTestPK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public void ejbLoad() {
      PerfTestPK pk = (PerfTestPK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   private PerfTestPK getPK() {
      return (PerfTestPK)this.mEntityContext.getPrimaryKey();
   }
   ...
   protected PerfTestDAO getDAO() {
      if(this.mPerfTestDAO == null) {
         this.mPerfTestDAO = new PerfTestDAO();
      }

      return this.mPerfTestDAO;
   }

   public PerfTestEVO getDetails(PerfTestCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public PerfTestEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public PerfTestEVO setAndGetDetails(PerfTestEVO evo, String dependants) {

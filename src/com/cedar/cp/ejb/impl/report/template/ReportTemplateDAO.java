...
/*     */   protected static final String SQL_FIND_BY_PRIMARY_KEY = "select REPORT_TEMPLATE_ID from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ";
/*     */   private static final String SQL_SELECT_LOBS = "select  DOCUMENT from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? for update";
/*     */   private static final String SQL_SELECT_COLUMNS = "select REPORT_TEMPLATE.DOCUMENT,REPORT_TEMPLATE.REPORT_TEMPLATE_ID,REPORT_TEMPLATE.VIS_ID,REPORT_TEMPLATE.DESCRIPTION,REPORT_TEMPLATE.DOCUMENT_NAME,REPORT_TEMPLATE.VERSION_NUM,REPORT_TEMPLATE.UPDATED_BY_USER_ID,REPORT_TEMPLATE.UPDATED_TIME,REPORT_TEMPLATE.CREATED_TIME";
/*     */   protected static final String SQL_LOAD = " from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ";
/*     */   protected static final String SQL_CREATE = "insert into REPORT_TEMPLATE ( REPORT_TEMPLATE_ID,VIS_ID,DESCRIPTION,DOCUMENT_NAME,DOCUMENT,VERSION_NUM,UPDATED_BY_USER_ID,UPDATED_TIME,CREATED_TIME) values ( ?,?,?,?,empty_blob(),?,?,?,?)";
/*     */   protected static final String SQL_UPDATE_SEQ_NUM = "update REPORT_TEMPLATE_SEQ set SEQ_NUM = SEQ_NUM + ?";
/*     */   protected static final String SQL_SELECT_SEQ_NUM = "select SEQ_NUM from REPORT_TEMPLATE_SEQ";
/*     */   protected static final String SQL_DUPLICATE_VALUE_CHECK_IDENTIFIER = "select count(*) from REPORT_TEMPLATE where    VIS_ID = ? and not(    REPORT_TEMPLATE_ID = ? )";
/*     */   protected static final String SQL_STORE = "update REPORT_TEMPLATE set VIS_ID = ?,DESCRIPTION = ?,DOCUMENT_NAME = ?,VERSION_NUM = ?,UPDATED_BY_USER_ID = ?,UPDATED_TIME = ?,CREATED_TIME = ? where    REPORT_TEMPLATE_ID = ? AND VERSION_NUM = ?";
/*     */   protected static final String SQL_CHECK_VERSION_NUM = "select VERSION_NUM from REPORT_TEMPLATE where REPORT_TEMPLATE_ID = ?";
/*     */   protected static final String SQL_REMOVE = "delete from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ";
/* 764 */   protected static String SQL_ALL_REPORT_TEMPLATES = "select 0       ,REPORT_TEMPLATE.REPORT_TEMPLATE_ID      ,REPORT_TEMPLATE.VIS_ID      ,REPORT_TEMPLATE.REPORT_TEMPLATE_ID      ,REPORT_TEMPLATE.DESCRIPTION from REPORT_TEMPLATE where 1=1 ";
/*     */   private static final String SQL_CHECK_IF_VALID = "select VERSION_NUM from REPORT_TEMPLATE where   REPORT_TEMPLATE_ID = ?";
/*     */   protected ReportTemplateEVO mDetails;
/*     */   private BLOB mDocumentBlob;
/*     */ 
/*     */   public ReportTemplateDAO(Connection connection)
/*     */   {
/*  41 */     super(connection);
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public ReportTemplateDAO(DataSource ds)
/*     */   {
/*  57 */     super(ds);
/*     */   }
/*     */ 
/*     */   protected ReportTemplatePK getPK()
/*     */   {
/*  65 */     return this.mDetails.getPK();
/*     */   }
/*     */ 
/*     */   public void setDetails(ReportTemplateEVO details)
/*     */   {
/*  74 */     this.mDetails = details.deepClone();
/*     */   }
/*     */ 
/*     */   public ReportTemplateEVO setAndGetDetails(ReportTemplateEVO details, String dependants)
/*     */   {
...
/*     */   }
/*     */ 
/*     */   public ReportTemplatePK create()
...
/*     */   }
/*     */ 
/*     */   public void load(ReportTemplatePK pk)
...
/*     */   }
/*     */ 
/*     */   public ReportTemplatePK findByPrimaryKey(ReportTemplatePK pk_)
/*     */     throws ValidationException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected boolean exists(ReportTemplatePK pk)
/*     */   {
...
/*     */     try
/*     */     {
/* 168 */       stmt = getConnection().prepareStatement("select REPORT_TEMPLATE_ID from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ");
/*     */ 
/* 170 */       int col = 1;
/* 171 */       stmt.setInt(col++, pk.getReportTemplateId());
/*     */ 
...
/*     */     {
/* 182 */       throw handleSQLException(pk, "select REPORT_TEMPLATE_ID from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */   }
/*     */ 
/*     */   private void selectLobs(ReportTemplateEVO evo_)
/*     */   {
...
/*     */     try
/*     */     {
/* 211 */       stmt = getConnection().prepareStatement("select  DOCUMENT from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? for update");
/*     */ 
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 225 */       throw handleSQLException(evo_.getPK(), "select  DOCUMENT from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? for update", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */   }
/*     */ 
/*     */   private void putLobs(ReportTemplateEVO evo_) throws SQLException
/*     */   {
/* 239 */     updateBlob(this.mDocumentBlob, evo_.getDocument());
/*     */   }
/*     */ 
/*     */   private ReportTemplateEVO getEvoFromJdbc(ResultSet resultSet_)
/*     */     throws SQLException
/*     */   {
/* 257 */     int col = 1;
/* 258 */     this.mDocumentBlob = ((BLOB)resultSet_.getBlob(col++));
/* 259 */     ReportTemplateEVO evo = new ReportTemplateEVO(resultSet_.getInt(col++), resultSet_.getString(col++), resultSet_.getString(col++), resultSet_.getString(col++), blobToByteArray(this.mDocumentBlob), resultSet_.getInt(col++));
/*     */ 
...
/*     */   }
/*     */ 
/*     */   private int putEvoKeysToJdbc(ReportTemplateEVO evo_, PreparedStatement stmt_, int startCol_)
/*     */     throws SQLException
/*     */   {
/* 293 */     int col = startCol_;
/* 294 */     stmt_.setInt(col++, evo_.getReportTemplateId());
/* 295 */     return col;
/*     */   }
/*     */ 
/*     */   private int putEvoDataToJdbc(ReportTemplateEVO evo_, PreparedStatement stmt_, int startCol_) throws SQLException
/*     */   {
...
/*     */   }
/*     */ 
/*     */   protected void doLoad(ReportTemplatePK pk)
/*     */     throws ValidationException
/*     */   {
...
/*     */     try
/*     */     {
/* 332 */       stmt = getConnection().prepareStatement("select REPORT_TEMPLATE.DOCUMENT,REPORT_TEMPLATE.REPORT_TEMPLATE_ID,REPORT_TEMPLATE.VIS_ID,REPORT_TEMPLATE.DESCRIPTION,REPORT_TEMPLATE.DOCUMENT_NAME,REPORT_TEMPLATE.VERSION_NUM,REPORT_TEMPLATE.UPDATED_BY_USER_ID,REPORT_TEMPLATE.UPDATED_TIME,REPORT_TEMPLATE.CREATED_TIME from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ");
/*     */ 
/* 335 */       int col = 1;
/* 336 */       stmt.setInt(col++, pk.getReportTemplateId());
/*     */ 
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 350 */       throw handleSQLException(pk, "select REPORT_TEMPLATE.DOCUMENT,REPORT_TEMPLATE.REPORT_TEMPLATE_ID,REPORT_TEMPLATE.VIS_ID,REPORT_TEMPLATE.DESCRIPTION,REPORT_TEMPLATE.DOCUMENT_NAME,REPORT_TEMPLATE.VERSION_NUM,REPORT_TEMPLATE.UPDATED_BY_USER_ID,REPORT_TEMPLATE.UPDATED_TIME,REPORT_TEMPLATE.CREATED_TIME from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/* 406 */       stmt = getConnection().prepareStatement("insert into REPORT_TEMPLATE ( REPORT_TEMPLATE_ID,VIS_ID,DESCRIPTION,DOCUMENT_NAME,DOCUMENT,VERSION_NUM,UPDATED_BY_USER_ID,UPDATED_TIME,CREATED_TIME) values ( ?,?,?,?,empty_blob(),?,?,?,?)");
/*     */ 
/* 409 */       int col = 1;
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 430 */       throw handleSQLException(this.mDetails.getPK(), "insert into REPORT_TEMPLATE ( REPORT_TEMPLATE_ID,VIS_ID,DESCRIPTION,DOCUMENT_NAME,DOCUMENT,VERSION_NUM,UPDATED_BY_USER_ID,UPDATED_TIME,CREATED_TIME) values ( ?,?,?,?,empty_blob(),?,?,?,?)", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */     try
/*     */     {
/* 467 */       sqlString = "update REPORT_TEMPLATE_SEQ set SEQ_NUM = SEQ_NUM + ?";
/* 468 */       stmt = getConnection().prepareStatement("update REPORT_TEMPLATE_SEQ set SEQ_NUM = SEQ_NUM + ?");
...
/*     */ 
/* 478 */       sqlString = "select SEQ_NUM from REPORT_TEMPLATE_SEQ";
/* 479 */       stmt = getConnection().prepareStatement("select SEQ_NUM from REPORT_TEMPLATE_SEQ");
...
/*     */   }
/*     */ 
/*     */   public ReportTemplatePK generateKeys()
/*     */   {
...
/*     */     try
/*     */     {
/* 537 */       stmt = getConnection().prepareStatement("select count(*) from REPORT_TEMPLATE where    VIS_ID = ? and not(    REPORT_TEMPLATE_ID = ? )");
/*     */ 
/* 540 */       int col = 1;
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 561 */       throw handleSQLException(getPK(), "select count(*) from REPORT_TEMPLATE where    VIS_ID = ? and not(    REPORT_TEMPLATE_ID = ? )", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/* 619 */         stmt = getConnection().prepareStatement("update REPORT_TEMPLATE set VIS_ID = ?,DESCRIPTION = ?,DOCUMENT_NAME = ?,VERSION_NUM = ?,UPDATED_BY_USER_ID = ?,UPDATED_TIME = ?,CREATED_TIME = ? where    REPORT_TEMPLATE_ID = ? AND VERSION_NUM = ?");
/*     */ 
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 650 */       throw handleSQLException(getPK(), "update REPORT_TEMPLATE set VIS_ID = ?,DESCRIPTION = ?,DOCUMENT_NAME = ?,VERSION_NUM = ?,UPDATED_BY_USER_ID = ?,UPDATED_TIME = ?,CREATED_TIME = ? where    REPORT_TEMPLATE_ID = ? AND VERSION_NUM = ?", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */     try
/*     */     {
/* 677 */       stmt = getConnection().prepareStatement("select VERSION_NUM from REPORT_TEMPLATE where REPORT_TEMPLATE_ID = ?");
/*     */ 
/* 680 */       int col = 1;
/* 681 */       stmt.setInt(col++, this.mDetails.getReportTemplateId());
/*     */ 
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 699 */       throw handleSQLException(getPK(), "select VERSION_NUM from REPORT_TEMPLATE where REPORT_TEMPLATE_ID = ?", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */     try
/*     */     {
/* 734 */       stmt = getConnection().prepareStatement("delete from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ");
/*     */ 
/* 737 */       int col = 1;
/* 738 */       stmt.setInt(col++, this.mDetails.getReportTemplateId());
/*     */ 
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 749 */       throw handleSQLException(getPK(), "delete from REPORT_TEMPLATE where    REPORT_TEMPLATE_ID = ? ", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/* 791 */     AllReportTemplatesELO results = new AllReportTemplatesELO();
/*     */     try
/*     */     {
/* 794 */       stmt = getConnection().prepareStatement(SQL_ALL_REPORT_TEMPLATES);
/* 795 */       int col = 1;
...
/* 799 */         col = 2;
/*     */ 
/* 802 */         ReportTemplatePK pkReportTemplate = new ReportTemplatePK(resultSet.getInt(col++));
/*     */ 
/* 805 */         String textReportTemplate = resultSet.getString(col++);
/*     */ 
/* 809 */         ReportTemplateRefImpl erReportTemplate = new ReportTemplateRefImpl(pkReportTemplate, textReportTemplate);
/*     */ 
/* 814 */         int col1 = resultSet.getInt(col++);
/* 815 */         String col2 = resultSet.getString(col++);
/*     */ 
/* 818 */         results.add(erReportTemplate, col1, col2);
/*     */       }
/*     */ 
/*     */     }
/*     */     catch (SQLException sqle)
/*     */     {
/* 827 */       throw handleSQLException(SQL_ALL_REPORT_TEMPLATES, sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */ 
/* 836 */     if (timer != null) {
/* 837 */       timer.logDebug("getAllReportTemplates", " items=" + results.size());
/*     */     }
/*     */ 
/* 841 */     return results;
/*     */   }
/*     */ 
/*     */   public ReportTemplateEVO getDetails(ReportTemplatePK pk, String dependants)
/*     */     throws ValidationException
/*     */   {
/* 859 */     return getDetails(new ReportTemplateCK(pk), dependants);
/*     */   }
/*     */ 
/*     */   public ReportTemplateEVO getDetails(ReportTemplateCK paramCK, String dependants)
/*     */     throws ValidationException
/*     */   {
/* 873 */     Timer timer = this._log.isDebugEnabled() ? new Timer(this._log) : null;
/*     */ 
/* 876 */     if (this.mDetails == null) {
/* 877 */       doLoad(paramCK.getReportTemplatePK());
/*     */     }
/* 879 */     else if (!this.mDetails.getPK().equals(paramCK.getReportTemplatePK())) {
/* 880 */       doLoad(paramCK.getReportTemplatePK());
/*     */     }
/* 882 */     else if (!checkIfValid())
/*     */     {
/* 884 */       this._log.info("getDetails", "[ALERT] ReportTemplateEVO " + this.mDetails.getPK() + " no longer valid - reloading");
/*     */ 
/* 886 */       doLoad(paramCK.getReportTemplatePK());
/*     */     }
/*     */ 
/* 890 */     ReportTemplateEVO details = new ReportTemplateEVO();
...
/*     */     try
/*     */     {
/* 912 */       stmt = getConnection().prepareStatement("select VERSION_NUM from REPORT_TEMPLATE where   REPORT_TEMPLATE_ID = ?");
/* 913 */       int col = 1;
/* 914 */       stmt.setInt(col++, this.mDetails.getReportTemplateId());
/*     */ 
...
/*     */     catch (SQLException sqle)
/*     */     {
/* 929 */       throw handleSQLException(this.mDetails.getPK(), "select VERSION_NUM from REPORT_TEMPLATE where   REPORT_TEMPLATE_ID = ?", sqle);
/*     */     }
/*     */     finally
/*     */     {
...
/*     */   }
/*     */ 
/*     */   public ReportTemplateEVO getDetails(String dependants)
/*     */     throws ValidationException
/*     */   {
...
/* 949 */     if (!checkIfValid())
/*     */     {
/* 951 */       this._log.info("getDetails", "ReportTemplate " + this.mDetails.getPK() + " no longer valid - reloading");
/* 952 */       doLoad(this.mDetails.getPK());
/*     */     }
/*     */ 
/* 956 */     ReportTemplateEVO details = this.mDetails.deepClone();
/*     */ 
/* 958 */     if (timer != null) {
...
/*     */   {
/* 966 */     return "ReportTemplate";
/*     */   }
/*     */ 
/*     */   public ReportTemplateRef getRef(ReportTemplatePK paramReportTemplatePK)
/*     */     throws ValidationException
/*     */   {
/* 972 */     ReportTemplateEVO evo = getDetails(paramReportTemplatePK, "");
/* 973 */     return evo.getEntityRef();
/*     */   }
/*     */ }

/* Location:           /home/oracle/coa/cp.ear/cp.ear_orginal/cp-server.jar
 * Qualified Name:     com.cedar.cp.ejb.impl.report.template.ReportTemplateDAO

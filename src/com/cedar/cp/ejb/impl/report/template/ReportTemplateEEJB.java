...
public class ReportTemplateEEJB implements EntityBean {

   protected EntityContext mEntityContext;
   private ReportTemplateDAO mReportTemplateDAO;
   private transient Log mLog = new Log(this.getClass());


   public ReportTemplatePK ejbCreate(ReportTemplateEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      ReportTemplatePK var4;
      try {
         ReportTemplateDAO e = this.getDAO();
   ...
   public void ejbPostCreate(ReportTemplateEVO details) throws CreateException, EJBException {}
   ...
   public ReportTemplatePK ejbFindByPrimaryKey(ReportTemplatePK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public void ejbLoad() {
      ReportTemplatePK pk = (ReportTemplatePK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   private ReportTemplatePK getPK() {
      return (ReportTemplatePK)this.mEntityContext.getPrimaryKey();
   }
   ...
   protected ReportTemplateDAO getDAO() {
      if(this.mReportTemplateDAO == null) {
         this.mReportTemplateDAO = new ReportTemplateDAO();
      }

      return this.mReportTemplateDAO;
   }

   public ReportTemplateEVO getDetails(ReportTemplateCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public ReportTemplateEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      ReportTemplateEVO var3;
      try {
   ...
   public ReportTemplateEVO setAndGetDetails(ReportTemplateEVO evo, String dependants) {

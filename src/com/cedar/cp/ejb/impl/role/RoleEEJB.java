...
public class RoleEEJB implements EntityBean {
   ...
   public RolePK ejbCreate(RoleEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      RolePK var4;
      try {
         RoleDAO e = this.getDAO();
   ...
   public void ejbPostCreate(RoleEVO details) throws CreateException, EJBException {}
   ...
   public void ejbLoad() {
      RolePK pk = (RolePK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
...
//            timer.logDebug("ejbStore", this.getPK().toString());
   ...
   private RolePK getPK() {
      return (RolePK)this.mEntityContext.getPrimaryKey();
   }
   ...
   protected RoleDAO getDAO() {
      if(this.mRoleDAO == null) {
         this.mRoleDAO = new RoleDAO();
      }

      return this.mRoleDAO;
   }

   public RoleEVO getDetails(RoleCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public RoleEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public RoleEVO getDetails(RoleCK paramCK) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public RoleEVO setAndGetDetails(RoleEVO evo, String dependants) {

...
public class SystemPropertyEEJB implements EntityBean {
   ...
   public SystemPropertyPK ejbCreate(SystemPropertyEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      SystemPropertyPK var4;
      try {
         SystemPropertyDAO e = this.getDAO();
   ...
   public void ejbPostCreate(SystemPropertyEVO details) throws CreateException, EJBException {}
   ...
   public SystemPropertyPK ejbFindByPrimaryKey(SystemPropertyPK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public void ejbLoad() {
      SystemPropertyPK pk = (SystemPropertyPK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
...
//         }
   ...
   private SystemPropertyPK getPK() {
      return (SystemPropertyPK)this.mEntityContext.getPrimaryKey();
   }
   ...
   protected SystemPropertyDAO getDAO() {
   ...
   public SystemPropertyEVO getDetails(SystemPropertyCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public SystemPropertyEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      SystemPropertyEVO var3;
      try {
   ...
   public SystemPropertyEVO setAndGetDetails(SystemPropertyEVO evo, String dependants) {

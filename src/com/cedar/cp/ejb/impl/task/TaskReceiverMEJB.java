...
import javax.ejb.MessageDrivenBean;
import javax.ejb.MessageDrivenContext;
@MessageDriven(name = "TaskReceiverMEJB", activationConfig = {
@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
@ActivationConfigProperty(propertyName = "useJNDI", propertyValue = "true"),
@ActivationConfigProperty(propertyName = "destination", propertyValue = "jms/cp/taskReceiverQueue"),
@ActivationConfigProperty(propertyName = "acknowledgeMode", propertyValue = "Auto-acknowledge") })

public class TaskReceiverMEJB implements MessageDrivenBean, MessageListener {
   ...
   public void ejbCreate() {
      try {
         this.mReceiverJmsConnection = new JmsConnectionImpl(this._jndiContext, 1, "taskReceiverQueue");

...
public class UdefLookupEEJB implements EntityBean {

   protected EntityContext mEntityContext;
   private UdefLookupDAO mUdefLookupDAO;
   private transient Log mLog = new Log(this.getClass());


   public UdefLookupPK ejbCreate(UdefLookupEVO details) throws CreateException, EJBException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;

      UdefLookupPK var4;
      try {
         UdefLookupDAO e = this.getDAO();
   ...
   public void ejbPostCreate(UdefLookupEVO details) throws CreateException, EJBException {}
   ...
   public UdefLookupPK ejbFindByPrimaryKey(UdefLookupPK pk) throws FinderException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public void ejbLoad() {
      UdefLookupPK pk = (UdefLookupPK)this.mEntityContext.getPrimaryKey();
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   private UdefLookupPK getPK() {
      return (UdefLookupPK)this.mEntityContext.getPrimaryKey();
   }
   ...
   protected UdefLookupDAO getDAO() {
      if(this.mUdefLookupDAO == null) {
         this.mUdefLookupDAO = new UdefLookupDAO();
      }

      return this.mUdefLookupDAO;
   }

   public UdefLookupEVO getDetails(UdefLookupCK paramCK, String dependants) throws ValidationException {
      return this.getDAO().getDetails(paramCK, dependants);
   }

   public UdefLookupEVO getDetails(String dependants) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public UdefLookupEVO getDetails(UdefLookupCK paramCK) throws ValidationException {
      Timer timer = this.mLog.isDebugEnabled()?new Timer(this.mLog):null;
   ...
   public UdefLookupEVO setAndGetDetails(UdefLookupEVO evo, String dependants) {

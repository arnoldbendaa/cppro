...
public class CPContext implements HttpSessionBindingListener, Serializable, ICPContext {
    ...
    protected static Log mLog = new Log(CPContext.class);
    ...
    private void destroy() {
        mLog.debug("destroy", "The session has expired and we are logging off");
        if (this.mLoggedOn) {
            this.logoff();
        }
    ...
    // TODO: usun����, jsp nie widzi metody
    public boolean getNewFeaturesEnabled() {
    ...
    // TODO: usun����, jsp nie widzi metody
    public boolean getShowBudgetActivity() {

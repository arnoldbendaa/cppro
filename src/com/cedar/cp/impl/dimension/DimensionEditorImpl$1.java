...
class DimensionEditorImpl$1 implements DimensionEventListener {

   // $FF: synthetic field
   final DimensionEditorImpl this$0;


   DimensionEditorImpl$1(DimensionEditorImpl var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(DimensionEvent e) throws CPException, ValidationException {
      DimensionEditorImpl.accessMethod000(this.this$0, (InsertDimensionElementEvent)e);
   }
}

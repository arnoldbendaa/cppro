...
class DimensionEditorImpl$2 implements DimensionEventListener {

   // $FF: synthetic field
   final DimensionEditorImpl this$0;


   DimensionEditorImpl$2(DimensionEditorImpl var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(DimensionEvent e) throws CPException, ValidationException {
      DimensionEditorImpl.accessMethod100(this.this$0, (RemoveDimensionElementEvent)e);
   }
}

...
class HierarchyEditorImpl$1 implements HierarchyEventListener {

   // $FF: synthetic field
   final HierarchyEditorImpl this$0;


   HierarchyEditorImpl$1(HierarchyEditorImpl var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(HierarchyEvent e) throws CPException, ValidationException {
      HierarchyEditorImpl.accessMethod000(this.this$0, (InsertHierarchyElementEvent)e);
   }
}

...
class HierarchyEditorImpl$5 implements HierarchyEventListener {

   // $FF: synthetic field
   final HierarchyEditorImpl this$0;


   HierarchyEditorImpl$5(HierarchyEditorImpl var1) {
      this.this$0 = var1;
   }

   public void dispatchEvent(HierarchyEvent e) throws CPException, ValidationException {
      HierarchyEditorImpl.accessMethod400(this.this$0, (UpdateHierarchyElementEvent)e);
   }
}

...
import com.cedar.cp.impl.message.MessageEditorImpl;
import com.cedar.cp.impl.message.MessagesProcessImpl;
import com.cedar.cp.util.Log;

public class MessageEditorSessionImpl extends BusinessSessionImpl implements MessageEditorSession {

   protected MessageEditorSessionSSO mServerSessionData;
   protected MessageImpl mEditorData;
   protected MessageEditorImpl mClientEditor;
   private Log mLog = new Log(this.getClass());


   public MessageEditorSessionImpl(MessagesProcessImpl process, Object key) throws ValidationException {
      super(process);
      ...
      try {
         ...
         throw new RuntimeException("Can\'t get Message", var5);
      }

      this.mEditorData = this.mServerSessionData.getEditorData();
   }

   protected MessageEditorSessionServer getSessionServer() throws CPException {
      return new MessageEditorSessionServer(this.getConnection());
   }

   public MessageEditor getMessageEditor() {
      if(this.mClientEditor == null) {
         this.mClientEditor = new MessageEditorImpl(this, this.mServerSessionData, this.mEditorData);

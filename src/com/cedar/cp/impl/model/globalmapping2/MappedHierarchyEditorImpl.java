...
public class MappedHierarchyEditorImpl extends SubBusinessEditorImpl implements MappedHierarchyEditor {
   ...
   private GlobalMappedModel2 getMappedModel() {
   ...
   public void setSelectedCompanies(List<FinanceCompany> companies) {
	   this.mMappedHierarchy.setSelectedCompanies(companies);
   }
   
   public void setSelectedCompany(String companyVisId, Boolean value) {
	   this.mMappedHierarchy.setSelectedCompany(companyVisId, value);
   }
}

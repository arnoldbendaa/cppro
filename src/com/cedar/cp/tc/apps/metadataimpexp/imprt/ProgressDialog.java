...
import com.cedar.cp.tc.apps.metadataimpexp.imprt.ProgressDialog$1;
import com.cedar.cp.tc.apps.metadataimpexp.imprt.ProgressDialog$2;
import com.cedar.cp.tc.apps.metadataimpexp.imprt.ProgressDialog$3;
...
public abstract class ProgressDialog extends JDialog {
   ...
   protected void showUserMessage(String msg) {
      try {
         SwingUtilities.invokeAndWait(new ProgressDialog$3(this, msg));
   ...
   // $FF: synthetic method
   static boolean accessMethod002(ProgressDialog x0, boolean x1) {

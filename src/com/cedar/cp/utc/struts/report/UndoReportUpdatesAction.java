...
public class UndoReportUpdatesAction extends CPAction {
   ...
   public ActionForward execute(ActionMapping actionMapping, ActionForm actionForm, HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception {
      ...
      try {
         ...
         int taskId = e.getReportsProcess().issueReportUpdateTask(new Integer(reportUpdateForm.getReportId()), true);
         String msg = MessageFormat.format("The task {0} has been submitted to undo the updates for report {1}.", new Object[]{new Integer(taskId), reportUpdateForm.getReportId()});

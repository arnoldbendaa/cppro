...
class WorkbookActions$10 extends AbstractAction {

   // $FF: synthetic field
   final WorkbookActions this$0;


   WorkbookActions$10(WorkbookActions var1, String x0, Icon x1) {
      super(x0, x1);
      this.this$0 = var1;
   }

   public void actionPerformed(ActionEvent e) {
      Color color = WorkbookActions.accessMethod300(this.this$0).getColor();
      if(color != null) {

...
class FlatformFunctionDialog$FunctionListSelection implements ListSelectionListener {

   // $FF: synthetic field
   final FlatformFunctionDialog this$0;


   private FlatformFunctionDialog$FunctionListSelection(FlatformFunctionDialog var1) {
      this.this$0 = var1;
   }
   ...
   // $FF: synthetic method
   FlatformFunctionDialog$FunctionListSelection(FlatformFunctionDialog x0, FlatformFunctionDialog$1 x1) {
      this(x0);
   }
}

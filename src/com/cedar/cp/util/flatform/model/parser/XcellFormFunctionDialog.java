...
public class XcellFormFunctionDialog extends OkCancelDialog {
   ...
   public XcellFormFunctionDialog(Frame owner, View xcellView, Worksheet worksheet, int row, int column) {
      super(owner, "Insert Function");
      //this.mWorksheetPanel = worksheetPanel;
      this.xcellView = xcellView;
   ...
   public XcellFormFunctionDialog(Dialog owner, View xcellView, Worksheet worksheet, int row, int column) {
      super(owner, "Insert Function");
      //this.mWorksheetPanel = worksheetPanel;
      this.xcellView = xcellView;
      this.mWorksheet = worksheet;
   ...
   private void buildData() {
      ...
      XcellFormFunctionDialog$CategoryListModel var7 = new XcellFormFunctionDialog$CategoryListModel(this, this.mCategories);
   ...
   private JPanel buildFunctionCategory() {
      ...
      this.mCategoryList.addListSelectionListener(new XcellFormFunctionDialog$CategoryListSelection(this, (XcellFormFunctionDialog$1)null));
      return p;
   }
   ...
   private JPanel buildFunctionName() {
      ...
      this.mFunctionList.addListSelectionListener(new XcellFormFunctionDialog$FunctionListSelection(this, (XcellFormFunctionDialog$1)null));
      return p;
   }
   ...
   protected void handleOk() {
      ...
      try {
    	  this.xcellView.setText(this.mRow, this.mColumn, func);
   ...
   public static void main(String[] argv) {
      ...
      try {
         SwingUtilities.invokeLater(new XcellFormFunctionDialog$1());

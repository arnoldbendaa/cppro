...
public class RoundupFunctionExecutor extends FunctionExecutor {

   public RoundupFunctionExecutor() {
      this.setName("ROUNDUP");
   }

   public Object execute(List params) {
      if(params == null) {
         throw new IllegalStateException("Wrong number of parameters to function ROUNDUP(). Expected 2 got 0");
      } else if(params.size() != 2) {
         throw new IllegalStateException("Wrong number of parameters to function ROUNDUP(). Expected 2 got " + params.size());
      } else {

...
/**
 * Servlet implementation class businessDimension
 */
@WebServlet("/businessDimension")
public class businessDimension extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public businessDimension() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("sidebar", "businessDimension");

		RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/WEB-INF/views/admin/businessDimension.jsp");
...
//        int userId = 1;
        ...
        if(operation.equals("read")){
			...
			String sql = "select * from dimension where type=2 order by VIS_ID";
			try {
				...
				while(rs.next()){
					...
					temp.put("4",1);//hierarchies column

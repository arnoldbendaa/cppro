    ...
    <main id="main-container">
        <div class="content bg-gray-lighter" style="background-color:#c7c7c7;padding:50px; ">
            <div class="row items-push" style="padding:20px;background-color:#f0f0f0;">
                <h1 class="text-center">Dimensions Account</h1>
                <table id="tblAccountDimension" class="display cell-border compact" cellspacing="0" width="100%">
                    <thead>
	                    <tr>
...
<script src="./scripts/accountDimension.js"></script>
</body>
</html>
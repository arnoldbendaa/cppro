...
<head>
    <title><bean:message key="cp.massupdate.popup.datatype.header.title"/></title>
    <bean:define id="listSize" type="Integer" property="size" name="massupdatePopupForm"/>
    <script language="javascript">
        function returnValue()
        {
            ...
            if (window.opener.setDataType != null)
            {
                window.opener.setDataType(name, id);
            }
...
<div dojoType="dijit.layout.BorderContainer" class="main" gutters="false">
    ...
    <div dojoType="dijit.layout.ContentPane" region="center" widgetId="dataTypeClient" style="padding-left:20px;padding-right:18px;overflow:auto;">
        <table width="100%">
            <tr>
                <th>
    ...
    <div dojoType="dijit.layout.ContentPane" region="bottom" widgetId="dataTypeFooter" style="padding-left:20px">
        <table width="100%">
            <tr>
